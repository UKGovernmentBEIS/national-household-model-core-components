...
public class ElectricCPSUTest {
	/**
	 * This is similar to the test in {@link ElectricCPSUTest2}, except it sets up the wider environment from which the transducer will get
	 * the parameters to go into the high rate fraction calculation.
	 */
	@Test
