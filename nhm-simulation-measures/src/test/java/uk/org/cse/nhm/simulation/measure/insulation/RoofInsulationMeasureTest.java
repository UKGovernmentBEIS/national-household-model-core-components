...
public class RoofInsulationMeasureTest {
	...
	private StructureModel mockStructure(final double externalRoofArea, final RoofConstructionType constructionType, final double existingInsulation) {
	...
	public void unsuitableForHousesWithNoRoof() {
		...
		final StructureModel sm = mockStructure(0d, ACCEPTABLE, 0d);
	...
	public void unsuitableForHousesWithNoLoft() {
		...
		final StructureModel sm = mockStructure(100d, ACCEPTABLE, INSULATION_THICKNESS - 10);
	...
	public void unsuitableForHousesWithWrongRoofType() {
		...
		final StructureModel sm = mockStructure(100d, RoofConstructionType.Thatched, 0d);
	...
	public void unsuitableWithoutTopupIfInsulated() {
		...
		final StructureModel sm = mockStructure(100d, ACCEPTABLE, 1d);
	...
	public void unsuitableWithTopupIfVeryInsulated() {
		...
		final StructureModel sm = mockStructure(100d, ACCEPTABLE, INSULATION_THICKNESS);
	...
	public void suitableWithoutTopupIfUninsulated() {
		...
		final StructureModel sm = mockStructure(100d, ACCEPTABLE, 0);
	...
	public void correctAmountIsInstalledWithTopup() throws NHMException {
		final RoofInsulationMeasure m = createMeasure(WITH_TOPUP);
		final StructureModel sm = mockStructure(100d, ACCEPTABLE, INSULATION_THICKNESS/2);
		final StructureModel out = mockStructure(100d, ACCEPTABLE, INSULATION_THICKNESS/2);
		final Storey storey = mock(Storey.class);
