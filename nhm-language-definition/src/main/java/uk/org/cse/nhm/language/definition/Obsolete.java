...
@Inherited
/**
 * Put the @Obsolete annotation on a language element's class to mark it as something that should no longer be used in the manual.
 */
public @interface Obsolete {
	...
	/**
	 * @return How to change an existing scenario to use a different language element.
	 */
