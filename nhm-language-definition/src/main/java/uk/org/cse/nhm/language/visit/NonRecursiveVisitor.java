...
/**
 * A visitor which will not visit identical elements if it is already inside them;
 * it is different from {@link SinglyVisitingVisitor} because it will visit something
 * twice if it occurs in two places, just not if it is used within its own definition.
 * 
 * @author hinton
 *
 * @param <V>
