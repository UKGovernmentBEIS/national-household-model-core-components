...
/**
 * Represents a variable in a sav file (a column in a table, effectively). Yielded typically by {@link SavMetadata#getVariables()}
 * 
 * @author hinton
 *
 */
public interface SavVariable {
	...
	/**
	 * @return as far as I can tell, 0 if this was a numeric value, or a number of bytes if it was a stringy value
	 */
	public int getVariableTypeCode();
	/**
	 * @return the 0-based index of this variable into its {@link SavMetadata#getVariables()} 
	 */
	public int getIndex();
	/**
	 * @param value
	 * @return the given double value for this variable, formatted by looking it up in the missing values table etc.
	 */
