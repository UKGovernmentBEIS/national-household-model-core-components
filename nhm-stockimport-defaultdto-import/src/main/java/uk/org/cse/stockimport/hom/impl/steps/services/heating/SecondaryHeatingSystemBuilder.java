...
/**
 * Builds a secondary heating system, which is always a room heater, by looking up attributes in a couple of maps and
 * on the {@link SecondaryHeatingSystemType} enum.
 * 
 * @author hinton
 * @since 1.0
 */
