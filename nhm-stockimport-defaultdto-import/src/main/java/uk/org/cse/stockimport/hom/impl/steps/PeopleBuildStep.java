...
public class PeopleBuildStep implements ISurveyCaseBuildStep {
    ...
    /**
     * @assumption If occupant details are null: moved in date, disabled/sick and on benefits will be null.
     * @assumption If number of adults or children are null: we set them to zero. That is, the house is empty.
     * @param model
     * @param dtoProvider
