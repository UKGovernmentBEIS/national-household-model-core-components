        ...
        public void accept(final Object o, final ISExpressionVisitor visitor) {
            ...
            if (o.getClass().isAnnotationPresent(Bind.class)) {
                ...
                for (final JasbPropertyDescriptor pd : positional) {
                    ...
                    if (value != null) {
                        if (haveHitNull) {
                            throw new IllegalArgumentException("Positional argument " + pd.position.get() + " is not null, but a previous positional argument was null, which is an illegal state");
                        }
                        accept(value, visitor);
                    } else {
                        haveHitNull = true;
                ...
                if (remainder.isEmpty() == false) {
                    ...
                    if (value != null) {
                        ...
                        if (things.isEmpty() == false) {
                            if (haveHitNull) {
                                throw new IllegalArgumentException("Remainder argument is not null or empty, but a previous positional argument was null, which is an illegal state");
                            }
