...
/**
 * Represents a location for an event in an s-expression event stream, or a node
 * in an actual expression. Since an event may come from an include, or a
 * template expansion, the location can be in several places.
 */
