...
/**
 * This is an abstract base class for things which can read invocations; these
 * are s-expression forms of the following sort:
 *
 * (name [key: expr]* expr*)
 *
 * <b>DO NOT</b> rename any of its methods, as they are used in generated
 * subtypes
 *
 * @author hinton
 *
