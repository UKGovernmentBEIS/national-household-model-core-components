...
/**
 * A base class for things which do edits; it is like {@link Cutout} but easier
 * to use because it is less recursively weird.
 *
 * @author hinton
 *
 */
public abstract class Editor implements ISExpressionVisitor {
    ...
    protected enum Action {
        ...
        Remove,
        /**
         * Cut this stuff out, edit it using the edit() method, and then apply
         * the editor to the result
         */
        RecursiveEdit,
        /**
