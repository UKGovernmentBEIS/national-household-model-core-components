...
public class UnifiedReport extends AbstractNamed implements IStateListener, ISimulationStepListener, Initializable, IUnifiedReport {
    ...
    /**
     * A single disaggregated record - when a house is sent to the report, it
     * makes one of these and puts it in the {@link UnifiedReport#buffer}
     */
    class Record implements IRecord {
        ...
        /**
         * the key field is entered by the user when they send a house to the
         * report
         */
    ...
    /**
     * Because the report wants to have information about things which were
     * selected, we keep a buffer of report rows in memory in the simulator
     * before we send them down the pipe to get written.
     *
     * This buffer could just as well be at the other end of the pipe, but one
     * of the things that has to happen is the aggregation, which depends on
     * knowing what aggregators are configured.
     *
