...
/**
 * The probe module. This depends on having {@link ISimulationLogger} bound, but
 * doesn't bind it.
 *
 * Please make sure you either bind one globally or use a SimulationProperty to
 * inject it when you run the simulator.
 *
 * @author hinton
 *
 */
