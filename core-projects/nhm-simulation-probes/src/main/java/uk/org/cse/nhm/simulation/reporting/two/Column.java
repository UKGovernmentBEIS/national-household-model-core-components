...
public class Column extends AbstractNamed implements IReportPart {
    ...
    /**
     * This should be set by the containing {@link UnifiedReport} during
     * construction. It's not nice, but it's because the
     * {@link UnifiedReport.Record} contains things in an array rather than a
     * map, since an array is rather lighter weight.
     */
    private int index = -1;
