...
public interface IHealthModule {
    ...
    /**
     * Compute the health impact of a change to a dwelling. The result is put
     * into an instance of T supplied by the given factory.
     *
     ...
     * @param h1 the specific heat loss (ventilation + fabric) before
     * intervention
     * @param h2 the specific heat loss (ventilation + fabric) after
     * intervention
     * @param form the built form of the dwelling
     * @param floorArea the total floor area of the dwelling (summed over
     * storeys)
     ...
     * @param hadDoubleGlazing whether the dwelling had more than 80% double or
     * triple glazing before the intervention
     * @param hasDoubleGlazing whether the dwelling has more than 80% double or
     * triple glazing after the intervention
     * @param people a list of the occupants in the house
     * @return An instanceof of T produced by factory, which has been told the
     * relevant information about health impacts.
     */
