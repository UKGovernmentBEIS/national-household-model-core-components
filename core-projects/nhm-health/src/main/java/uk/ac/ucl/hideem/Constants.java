...
public class Constants {
    ...
    /**
     * A risk constant ties together the two parameters for the log ratio with
     * the exposure type.
     *
     * The useful part is {@link #riskDueTo(HealthOutcome)}, which computes the
     * risk resulting from a change in exposure in the given health outcome.
     */
