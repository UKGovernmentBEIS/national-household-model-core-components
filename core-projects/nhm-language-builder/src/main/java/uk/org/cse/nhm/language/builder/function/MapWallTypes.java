...
public class MapWallTypes {
    ...
    public static final Set<WallConstructionType> getWallConstructionTypes(final XWallConstructionTypeRule x) {
        switch (x) {
            case Any:
                return WallConstructionType.getExternalWallTypes();
            case AnyCavity:
                return EnumSet.of(WallConstructionType.Cavity, WallConstructionType.TimberFrame, WallConstructionType.MetalFrame, WallConstructionType.SystemBuild);
            case AnySolid:
                return EnumSet.of(WallConstructionType.GraniteOrWhinstone, WallConstructionType.Sandstone, WallConstructionType.SolidBrick, WallConstructionType.Cob);
            case Cavity:
                return EnumSet.of(WallConstructionType.Cavity);
            case Cob:
                return EnumSet.of(WallConstructionType.Cob);
            case GraniteOrWhinstone:
                return EnumSet.of(WallConstructionType.GraniteOrWhinstone);
            case MetalFrame:
                return EnumSet.of(WallConstructionType.MetalFrame);
            case Sandstone:
                return EnumSet.of(WallConstructionType.Sandstone);
            case SolidBrick:
                return EnumSet.of(WallConstructionType.SolidBrick);
            case SystemBuild:
                return EnumSet.of(WallConstructionType.SystemBuild);
            case TimberFrame:
                return EnumSet.of(WallConstructionType.TimberFrame);
            default:
                throw new RuntimeException("Unknown XWallConsructionType " + x);
        }
    }
    ...
    public static final Predicate<Set<WallInsulationType>> getPredicateMatching(final XWallInsulationRule x) {
        ...
        return new Predicate<Set<WallInsulationType>>() {
            ...
            public boolean apply(final @Nullable Set<WallInsulationType> arg0) {
                switch (x) {
                    case NoCavity:
                        return !arg0.contains(WallInsulationType.FilledCavity);
                    case NoExternal:
                        return !arg0.contains(WallInsulationType.External);
                    case NoInsulation:
                        return arg0.isEmpty();
                    case NoInternal:
                        return !arg0.contains(WallInsulationType.Internal);
                    case SomeInsulation:
                        return !arg0.isEmpty();
                    case Any:
                        return true;
                    case OnlyFilledCavity:
                        return arg0.equals(EnumSet.of(WallInsulationType.FilledCavity));
                    case OnlyExternal:
                        return arg0.equals(EnumSet.of(WallInsulationType.External));
                    case OnlyInternal:
                        return arg0.equals(EnumSet.of(WallInsulationType.Internal));
                    default:
                        return false;
                }
            }
