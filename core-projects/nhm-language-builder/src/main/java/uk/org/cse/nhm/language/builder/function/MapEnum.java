...
public class MapEnum {
    ...
    public static final FuelType fuel(final XFuelType fuel) {
        switch (fuel) {
            case BiomassPellets:
                return FuelType.BIOMASS_PELLETS;
            case BiomassWood:
                return FuelType.BIOMASS_WOOD;
            case BiomassWoodchip:
                return FuelType.BIOMASS_WOODCHIP;
            case BottledLPG:
                return FuelType.BOTTLED_LPG;
            case BulkLPG:
                return FuelType.BULK_LPG;
            case CommunityHeat:
                return FuelType.COMMUNITY_HEAT;
            case Electricity:
                return FuelType.ELECTRICITY;
            case PeakElectricity:
                return FuelType.PEAK_ELECTRICITY;
            case OffPeakElectricity:
                return FuelType.OFF_PEAK_ELECTRICITY;
            case HouseCoal:
            ...
            case ExportedElectricity:
                return FuelType.EXPORTED_ELECTRICITY;
            default:
                throw new RuntimeException("Unexpected XFuelType " + fuel);
        }
    }
    ...
    public static final EnergyCalculatorType energyCalc(final XEnergyCalculatorType calculatorType) {
        switch (calculatorType) {
            ...
            case SAP2012_PHYSICAL:
                return EnergyCalculatorType.SAP2012_UVALUES;
            case BEIS:
                return EnergyCalculatorType.BEIS;
            default:
                throw new RuntimeException("Unexpected XEnergyCalculatorType " + calculatorType);
        }
    }
