...
public class ChimneyEntryImpl extends SurveyEntryImpl implements ChimneyEntry {

    private Integer FRONT_ReplacementPeriod;
    private Integer BACK_Age;
    private Integer FRONT_Age;
    private Integer FRONT_Rebuild;
    private Integer FRONT_RepointRefixPot;
    private Integer FRONT_Number;
    private Integer BACK_ReplacementPeriod;
    private Integer BACK_Rebuild;
    private Integer FRONT_PartRebuild;
    private Integer FRONT_Leave;
    private Integer BACK_Leave;
    private Integer BACK_PartRebuild;
    private Integer BACK_Number;
    private Integer BACK_RepointRefixPot;
    ...
    private Enum1216 TypeOfChimney;
    ...
    public Integer getFRONT_Rebuild() {
        return FRONT_Rebuild;
    }

    public void setFRONT_Rebuild(final Integer FRONT_Rebuild) {
        this.FRONT_Rebuild = FRONT_Rebuild;
    }

    public Integer getFRONT_RepointRefixPot() {
        return FRONT_RepointRefixPot;
    }

    public void setFRONT_RepointRefixPot(final Integer FRONT_RepointRefixPot) {
        this.FRONT_RepointRefixPot = FRONT_RepointRefixPot;
    }
    ...
    public void setBACK_Rebuild(final Integer BACK_Rebuild) {
        this.BACK_Rebuild = BACK_Rebuild;
    }

    public Integer getFRONT_PartRebuild() {
        return FRONT_PartRebuild;
    }

    public void setFRONT_PartRebuild(final Integer FRONT_PartRebuild) {
        this.FRONT_PartRebuild = FRONT_PartRebuild;
    }
    ...
    public Integer getBACK_PartRebuild() {
        return BACK_PartRebuild;
    }

    public void setBACK_PartRebuild(final Integer BACK_PartRebuild) {
        this.BACK_PartRebuild = BACK_PartRebuild;
    }
    ...
    public Integer getBACK_RepointRefixPot() {
        return BACK_RepointRefixPot;
    }

    public void setBACK_RepointRefixPot(final Integer BACK_RepointRefixPot) {
        this.BACK_RepointRefixPot = BACK_RepointRefixPot;
    }
    ...
    public Enum1216 getTypeOfChimney() {
        return TypeOfChimney;
    }

    public void setTypeOfChimney(final Enum1216 TypeOfChimney) {
        this.TypeOfChimney = TypeOfChimney;
    }
