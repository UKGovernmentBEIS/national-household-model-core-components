...
import uk.org.cse.nhm.ehcs10.physical.RoofcovEntry;
...
public class RoofcovEntryImpl extends SurveyEntryImpl implements RoofcovEntry {

    private Integer BACK_Renew;
    private Integer FRONT_ReplacementPeriod;
    private Integer BACK_ReplacementPeriod;
    private Integer BACK_Leave;
    private Integer FRONT_Renew;
    ...
    private Enum1691 FRONT_Faults;
    private Enum10 FRONT_Urgent_;
    private Enum1693 TypeOfRoofCovering;
    private Enum1691 BACK_Faults;
    ...
    public void setBACK_Renew(final Integer BACK_Renew) {
        this.BACK_Renew = BACK_Renew;
    }
    ...
    public void setFRONT_Renew(final Integer FRONT_Renew) {
        this.FRONT_Renew = FRONT_Renew;
    }
    ...
    public void setFRONT_Faults(final Enum1691 FRONT_Faults) {
    ...
    public Enum1693 getTypeOfRoofCovering() {
        return TypeOfRoofCovering;
    }

    public void setTypeOfRoofCovering(final Enum1693 TypeOfRoofCovering) {
        this.TypeOfRoofCovering = TypeOfRoofCovering;
    }
    ...
    public void setBACK_Faults(final Enum1691 BACK_Faults) {
