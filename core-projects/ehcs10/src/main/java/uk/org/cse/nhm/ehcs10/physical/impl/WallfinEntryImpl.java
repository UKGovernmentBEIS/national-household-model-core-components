...
public class WallfinEntryImpl extends SurveyEntryImpl implements WallfinEntry {
	...
	public Integer getBACK_IsolatedRepairs() {
		return BACK_IsolatedRepairs;	}

	public void setBACK_IsolatedRepairs(final Integer BACK_IsolatedRepairs) {
		this.BACK_IsolatedRepairs = BACK_IsolatedRepairs;	}
	...
	public Integer getFRONT_IsolatedRepairs() {
		return FRONT_IsolatedRepairs;	}

	public void setFRONT_IsolatedRepairs(final Integer FRONT_IsolatedRepairs) {
		this.FRONT_IsolatedRepairs = FRONT_IsolatedRepairs;	}
	...
	public Integer getFRONT_RenewRepoint() {
		return FRONT_RenewRepoint;	}

	public void setFRONT_RenewRepoint(final Integer FRONT_RenewRepoint) {
		this.FRONT_RenewRepoint = FRONT_RenewRepoint;	}

	public Integer getBACK_RenewRepoint() {
		return BACK_RenewRepoint;	}

	public void setBACK_RenewRepoint(final Integer BACK_RenewRepoint) {
		this.BACK_RenewRepoint = BACK_RenewRepoint;	}
	...
	public void setBACK_Render(final Integer BACK_Render) {
		this.BACK_Render = BACK_Render;	}
	...
	public void setFRONT_Render(final Integer FRONT_Render) {
		this.FRONT_Render = FRONT_Render;	}
	...
	public Enum1995 getTypeOfWallFinish() {
		return TypeOfWallFinish;	}

	public void setTypeOfWallFinish(final Enum1995 TypeOfWallFinish) {
		this.TypeOfWallFinish = TypeOfWallFinish;	}
