...
/**
 * Provides information about the NHM language, and answers questions
 * for content assist purposes about what can be typed in where.
 */
public interface ILanguage {
    /**
     * A linkedlist from where the cursor is backwards up to the top of the scenario
     */
    public interface ICursor {
        /**
         * The name of the command around this cursor, so something
         * like "scenario" or "apply"
         */
        public String command();
        
        /**
         * @return the text left of the insertion point, if we are at an argument
         */
        public String left();
