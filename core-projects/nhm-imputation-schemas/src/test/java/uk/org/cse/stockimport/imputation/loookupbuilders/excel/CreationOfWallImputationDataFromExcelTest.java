...
public class CreationOfWallImputationDataFromExcelTest extends AbsImputationFromExcelTest{
	...
	public void GraniteUValuesMustMatchThoseInExcelShee() {
		...
		Assert.assertEquals(1.7, imputer.getUValue(E,England,GraniteOrWhinstone,none,0d));
		Assert.assertEquals(0.45, imputer.getUValue(I,England,GraniteOrWhinstone,none,0d));
		Assert.assertEquals(0.30, imputer.getUValue(K,England,GraniteOrWhinstone,none,0d));
	}
	...
	public void SandstoneUValuesMustMatchThoseInExcelShee() {
		...
		Assert.assertEquals(1.7, imputer.getUValue(E,England,Sandstone,none,0d));
		Assert.assertEquals(0.6, imputer.getUValue(H,England,Sandstone,none,0d));
		Assert.assertEquals(0.30, imputer.getUValue(K,England,Sandstone,none,0d));
	}
	...
	public void SolidBrickUValuesMustMatchThoseInExcelSheet() {
		...
		Assert.assertEquals(1.7, imputer.getUValue(E,England,SolidBrick,none,0d));
		Assert.assertEquals(0.6, imputer.getUValue(H,England,SolidBrick,none,0d));
		Assert.assertEquals(0.30, imputer.getUValue(K,England,SolidBrick,none,0d));
	}
	...
	public void InsulatedBrickOrStoneUValuesMustMatchThoseInExcelShee() {
		...
		Assert.assertEquals(0.55, imputer.getUValue(E, England, SolidBrick, none, 0d));
		Assert.assertEquals(0.45, imputer.getUValue(F, England, SolidBrick, none, 0d));
	}
	...
	public void CobUValuesMustMatchThoseInExcelSheet() {
		...
		Assert.assertEquals(0.80, imputer.getUValue(A, England, Cob, none, 0d));

		none.put(WallInsulationType.Internal, 50d);
		Assert.assertEquals(0.40, imputer.getUValue(B, England, Cob, none, 0d));

		none.put(WallInsulationType.Internal, 100d);
		Assert.assertEquals(0.26, imputer.getUValue(C, England, Cob, none, 0d));

		none.put(WallInsulationType.Internal, 150d);
		Assert.assertEquals(0.20, imputer.getUValue(D, England, Cob, none, 0d));
	}
	...
	public void UnfilledCavityUValuesMustMatchThoseInExcelSheet() {
		...
		//No insulation
		Assert.assertEquals(2.10, imputer.getUValue(A, England, Cavity, none, 0d));
		//Add 50mm of internal insulation to unfilled cavity
		none.put(WallInsulationType.Internal, 50d);
		Assert.assertEquals(0.35, imputer.getUValue(G, England, Cavity, none, 0d));
	}
	...
	public void FilledCavityUValuesMustMatchThoseInExcelSheet() {
		...
		Assert.assertEquals(0.65, imputer.getUValue(A, England, Cavity, none, 0d));

		none.put(WallInsulationType.Internal, 50d);
		Assert.assertEquals(0.31, imputer.getUValue(B, England, Cavity, none, 0d));

		none.put(WallInsulationType.Internal, 100d);
		Assert.assertEquals(0.22, imputer.getUValue(C, England, Cavity, none, 0d));

		none.put(WallInsulationType.Internal, 150d);
		Assert.assertEquals(0.17, imputer.getUValue(D, England, Cavity, none, 0d));
	}
	...
	public void TimberFrameUValuesMustMatchThoseInExcelSheet() {
		...
		Assert.assertEquals(2.5, imputer.getUValue(A, England, TimberFrame, none, 0d));

		none.put(WallInsulationType.Internal, 50d);
		Assert.assertEquals(0.30, imputer.getUValue(K, England, Cavity, none, 0d));
	}
	...
	public void SystemBuildUValuesMustMatchThoseInExcelSheet() {
		...
		Assert.assertEquals(2.0, imputer.getUValue(A, England, SystemBuild, none, 0d));

		none.put(WallInsulationType.Internal, 50d);
		Assert.assertEquals(0.60, imputer.getUValue(B, England, SystemBuild, none, 0d));

		none.put(WallInsulationType.Internal, 100d);
		Assert.assertEquals(0.35, imputer.getUValue(C, England, SystemBuild, none, 0d));

		none.put(WallInsulationType.Internal, 150d);
		Assert.assertEquals(0.14, imputer.getUValue(K, England, SystemBuild, none, 0d));
	}
	...
	public void MetalFrameUValuesMustMatchThoseInExcelSheet() {
		...
		Assert.assertEquals(2.2, imputer.getUValue(A, England, MetalFrame, none, 0d));

		none.put(WallInsulationType.Internal, 50d);
		Assert.assertEquals(2.2, imputer.getUValue(A, England, MetalFrame, none, 0d));

		Assert.assertEquals(0.86, imputer.getUValue(E, England, MetalFrame, none, 0d));
		Assert.assertEquals(0.30, imputer.getUValue(K, England, MetalFrame, none, 0d));
	}
}
