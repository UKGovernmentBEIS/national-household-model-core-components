...
public class WallThicknessImputer implements IWallThicknessImputer {
	...
	/* (non-Javadoc)
	 * @see uk.org.cse.stockimport.imputation.tables.IWallThicknessImputer#getWallThickness(uk.org.cse.nhm.hom.types.SAPAgeBandValue, uk.org.cse.nhm.hom.types.RegionType, uk.org.cse.nhm.energycalculator.api.types.WallConstructionType, java.util.Set)
	 */
    @Override
