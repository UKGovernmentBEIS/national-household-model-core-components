...
public class WallUValueImputer implements IWallUValueImputer {
	 ...
	 * @param ageBandValue
	 * @param insulationThickness - for unfilled cavity assume greater than zero is insulated
	 * @param uValue
	...
	/**
	 * This is the "tail-end" of the second row of table S6, where the values are constants rather than equations,
	 * starting at SAP age band E
	 */
	...
	/**
	 * Values for insulated or uninsulated filled cavity wall
	 * Because RDSAP specifies (in the annotations to table S6) that unfilled wall with internal
	 * or external insulation is to be treated as filled cavity wall for the purposes of the SAP
	 * calculation, the second row of this is the same as the first row of {@link #filledCavityInsulated}.
     *
	...
	/**
	 * The constant 3.3 in RDSAP equation S5.1.1 U = 3.3 - 0.002 * wall thickness in mm
	 */
	private double graniteConstant;

	/**
	 * The constant 0.002 in RDSAP equation S5.1.1 U = 3.3 - 0.002 * wall thickness in mm
	 */
	private double graniteCoefficient;

	/**
	 * @assumption U values for metal frame insulated walls are taken directly from the CHM spreadsheet, because RDSAP doesn't
