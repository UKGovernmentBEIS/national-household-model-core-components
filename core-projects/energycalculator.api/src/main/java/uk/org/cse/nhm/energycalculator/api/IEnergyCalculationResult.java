...
public interface IEnergyCalculationResult {
	...
	/**
	 * @return a map from area type to the total area (m2) of that area type encountered.
	 */
	public Map<AreaType, Double> getHeatLossAreas();
	/**
	 * @return a map from area type to the total heat loss for which that area type is responsible.
	 */
