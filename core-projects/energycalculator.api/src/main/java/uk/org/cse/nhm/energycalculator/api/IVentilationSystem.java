...
/**
 * A ventilation system - this will be present when there is full mechanical
 * ventilation, or MVHR
 *
 * @author hinton
 *
...
public interface IVentilationSystem {
     ...
     *
     * @param houseAirChangeRate the air change rate otherwise (e.g. the
     * ventilation rate computed from walls, windows etc)
