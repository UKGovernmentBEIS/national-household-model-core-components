...
public class EnergyCalculatorType {
    ...
    public enum ECUvalues {
        ...
        public double getFloor(double uValue, boolean isPartyFloor, boolean isGroundFloor, double area,
            ...
            switch (this) {
                ...
                default:
                    throw new RuntimeException(this + " has no defined floor u-values");
            }
        }
        ...
        public double getWallAirChangeRate(double ach, final WallConstructionType wallType) {
            switch (this) {
                case SCENARIO:
                    return ach;
                case SAP2012:
                    return SAPTables.Walls.infiltration(wallType);
                default:
                    throw new RuntimeException(this + " has no defined wall air change rate");
            }
        }
        ...
        public double getFrameFactor(double _frameFactor, FrameType frameType) {
            switch (this) {
                case SCENARIO:
                    return _frameFactor;
                case SAP2012:
                    return SAPTables.Windows.frameFactor(frameType);
                default:
                    throw new RuntimeException(this + " has no defined frame factor");
            }
        }
        ...
        public double getVisibleLightTransmissivity(double _visibleLightTransmittivity, GlazingType glazingType) {
            switch (this) {
                case SCENARIO:
                    return _visibleLightTransmittivity;
                case SAP2012:
                    return SAPTables.Windows.visibleLightTransmittivity(glazingType);
                default:
                    throw new RuntimeException(this + " has no defined transmissivity for visible light");
            }
        }
        ...
        public double getSolarGainTransmissivity(double _solarGainTransmissivity, GlazingType glazingType,
            ...
            switch (this) {
                case SCENARIO:
                    return _solarGainTransmissivity;
                case SAP2012:
                    return SAPTables.Windows.solarGainTransmissivity(glazingType, insulationType);
                default:
                    throw new RuntimeException(this + " has no defined transmissivity for solar gains");
            }
        }
    }
    ...
    public enum ECWeather {
        ...
        public double getLatitude(double latitudeRadians) {
            if (this == SAP2012) {
                return RegionType.UK_AVERAGE_LATITUDE_RADIANS;
            } else {
