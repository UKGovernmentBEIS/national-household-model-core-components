...
public class SAPTables {
    ...
    public static class Walls {
        ...
        static {
            /**
             * SAP 2012 Tables S6, S7, S8 Rows of the same time must be added in
             * order from most insulation to least insulation.
             */
        ...
        private static void extRow(final Set<WallConstructionType> constructionTypes, final Set<Country> countries, final double minimumInsulation, final Optional<Boolean> filledCavity, final double[] uValues) {
            ...
            for (final WallConstructionType type : constructionTypes) {
                if (!externalRows.containsKey(type)) {
                    externalRows.put(type, new ArrayList<>());
                }
     ...
     *
     * (We have no information about hallways or stairwells adjacent to the
    ...
    public static class Doors {
        ...
        /**
         * @param country
         * @return the u-value for an outside door according to SAP 2012 Table
         * S15A
         */
     ...
     *
     * (RdSAP also includes a Table S14, but we ignore this as we have extra
     * information about frame type and insulation in the model.)
     *
    ...
    /**
     * Floor u-value lookup based on S5.5 for ground floors, and Table S12 for
     * other floors with heat loss areas.
     *
    ...
    /**
     * Roof u-value lookup based on Tables S9 (for PitchedSlateOrTiles or
     * Thatched) and S10 (for Flat).
     */
