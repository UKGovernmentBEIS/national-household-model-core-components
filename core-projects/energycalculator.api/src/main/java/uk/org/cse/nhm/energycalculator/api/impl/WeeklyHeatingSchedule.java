...
/**
 * A heating schedule which takes the weighted average of two other heating
 * schedules, the first being weekdays and the second being weekend days.
 *
 * The intention is that this is used to combine two
 * {@link DailyHeatingSchedule}s, which handle the daily averages.
 *
 * @author hinton
 *
 */
public class WeeklyHeatingSchedule implements IHeatingSchedule {
    ...
    /**
     * Make a new weekly schedule which has the given sub-schedules for weekdays
     * and weekends
     *
     * @param weekdays
     * @param weekends
