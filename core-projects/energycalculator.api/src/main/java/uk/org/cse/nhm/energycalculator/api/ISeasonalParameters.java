...
public interface ISeasonalParameters {
    ...
    /**
     * @return the wind speed at the place where the algorithm is being
     * evaluated
     */
    ...
    /**
     * Return the mean solar flux in watts/m2 onto a plane at the given angle
     * from the horizontal (so angleFromHorizontal == 0 is a degenerate case
     * where the plane is pointing at the sky; angleFromHorizontal == 90 is the
     * extreme where the plane is pointing at the horizon; angleFromNorth is the
     * angle between the vertical of the plane and the north vector).
     *
...
//	double getHotWaterRise();
    /**
     * @param zone
     * @param zone2ControlParameter switches the zone 2 heating schedule based
     * on SAP 2012 Table 9. Not applicable in BREDEM 2012 mode.
     ...
     * into the same code. return the proportion of the month for which the
     * heating is on.
     *
