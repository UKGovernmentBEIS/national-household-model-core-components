...
public interface IConstants {
    ...
    /**
     * Get a constant out of the constants table, returning it as an instance of
     * the given class if possible
     *
     * @param key the constant to look up
     * @param clazz the class to return
     * @return the value of the given constant, if it can be represented as the
     * given class. Otherwise you will get a runtime exception.
     */
    ...
    /**
     * Synonymous with <code>get(key, index.ordinal())</code>. The intent is
     * that for constants which are tables (i.e. arrays of doubles) indexed by
