...
public interface IEnergyState {
    ...
    /**
     * A special case, which subtracts heat provided by internals before doing
     * what {@link #getBoundedTotalDemand(EnergyType, double)} does.
     *
     * @param energy
    ...
    /**
     * Equivalent to Math.min(getUnsatisfiedDemand(energy),
    ...
    /**
     * Satisfy some of the demand for the given type of energy - if there is not
     * this much demand, there is an oversupply.
     *
     * @param energy
     * @param amount
     */
    ...
    /**
     * Get the amount of energy being satisfied for the given demand by the
     * given service.
     *
     * @param energy
     * @param service
