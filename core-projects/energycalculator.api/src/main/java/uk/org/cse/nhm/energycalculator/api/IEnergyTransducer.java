 ...
 *
 * A single device might have more than one transducer in it (for example, a
 * heating system which is also a hot water system would have a heat transducer
 * and a hot water transducer).
 *
 * @author hinton
 *
 */
public interface IEnergyTransducer {
     ...
     *
     * @param house the house which is being evaluated (this is passed in so
     * that house components needn't know what house they are in, allowing for
     * easy mongo serialization)
     * @param parameters the parameters (temp etc.) in use (heat pumps will need
     * these)
    ...
    /**
     * @return the priority of this system, amongst other systems which don't
     * interact.
     */
