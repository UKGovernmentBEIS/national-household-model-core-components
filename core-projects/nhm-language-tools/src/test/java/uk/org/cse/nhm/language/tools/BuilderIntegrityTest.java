...
/**
 * This suite of tests does static analysis of all the adapters in the
 * classpath, and checks that they are not doing anything silly
 *
 * @author hinton
 *
 */
public class BuilderIntegrityTest {
    ...
    /**
     * There should be getters in all the adapted types for the values being
     * adapted
     *
     * @param m
     */
    ...
    /**
     * If you have things annotated with the same @Prop annotation, it is
     * probably a mistake.
     *
     * @param m
     */
