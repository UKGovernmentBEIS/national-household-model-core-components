...
/**
 * <p>
 * News up a {@link CliStockService} using stockFileLocation as the location of
 * the JsonFile to create a stock, exposed as a {@link IStockService}.</p>
 * <p>
 * News up a {@link ISimulationExecutor} and exposed this ready to run
 * simulations against.</p>
 *
 * @author richardt
 *
 */
