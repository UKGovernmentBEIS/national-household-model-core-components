...
public class FindUsedElements {
    ...
    /**
     * Usage: main(<somewhere with .s files>, [somewhere to resolve includes])
     *
     * Behaviour: recursively traverses the directory, loads each .s file,
     * expands any templates, collects up what elements are used in the
     * scenario.
     *
     * @param args
     * @throws IOException
