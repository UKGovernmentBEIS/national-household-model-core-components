...
/**
 * Utility class which implements versions of {@link ITable}, overriding/implementing any getters annotated with {@link Column}
 * 
 * @author hinton
 * @since 1.0
 */
public class AutoTable {
	/**
	 * Instantiate an implementation of the given interface, based off the given base class.
	 * 
	 * All methods annotated with {@link Column} that are invoked on the resulting class will be handled by lookup
	 * up in the sedbuk table with the given column number. All other methods will be handled on the base class.
	 * 
