...
public class SedbukFix {
     ...
     * We've chosen the 630, as it has the same efficiency that CHM have used in
     * most cases.
     * @assumption Vaillant Turboxmax models all have a similar efficiency.
     * We've chosen the VUW 282 EH, as it has the same efficiency that CHM have
     * used in most cases.
     * @assumption Worcester Heat Slave 15/19 could match 15/19.OSO or
     * 15/19.RSO. These have the same efficiency so we have chosen OSO.
     * @assumption Ideal Classic LXRS could match several models with similar
     * efficiency. We've chosen LX RS250 as it has the median efficiency of
     * those models.
     * @assumption Potterton Statesman could match several models with similar
     * efficiency. We've chosen 45/50L as it has the same efficiency that CHM
     * have used in most cases.
     * @assumption Avanta plus could match several models with similar
     * efficiency. We've chosen 24s as it has the same efficiency that CHM have
     * used in most cases.
     * @assumption Solo 3 pfl could match several models with similar
     * efficiency. We've chosen 30 as it has the median efficiency of those
     * models.
     *
     * @param brand
     * @param model
