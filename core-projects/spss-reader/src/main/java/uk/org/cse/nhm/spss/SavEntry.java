...
public interface SavEntry {
     ...
     *
     * @param variable the variable to get (as picked from
     ...
     * Get the value of the given variable out of the row, in the given type
     *
     * @param variable the column number of the variable (0 based, in the order
     * given by {@link SavMetadata#getVariables()}
     * @param clazz the type to return
     * @return
     */
    ...
    /**
     * @param variable
     * @return true if the stored value for the variable at the given index is a
     ...
     *
     * @param variable
     * @return true iff the given variable has one of the predefined values in
     * this entry
     */
