...
/**
 * This is the base class which things from the {@link SavStreamWrapperBuilder} will extend;
 * 
 * It is basically an internal detail of how that class works. It contains a {@link SavMetadata} and a
 * {@link SavEntry} which the proxied interfaces that the stream wrapper builder returns
