...
/**
 * A base class for heating measures which gets injected with the {@link EnergyStateComponent} and uses
 * it to provide utility methods to subclasses around water and space heating demand.
 *
 * @author hinton
 *
 */
public abstract class AbstractHeatingMeasure extends AbstractMeasure {
	 ...
	 * @return a measure applied result, or absent if can't work for some reason.
	 * @throws NHMException
	 */
	...
	/**
	 * Subclasses should implement this to test their suitability. This will only be called if the sizing function
	 * says a size is available for the house.
	 * 
	 * @param components
