...
/**
 * This class is intended to decouple {@link WetHeatingMeasure} and
 * {@link AbstractHeatingMeasure}. It has no behaviour, it just hides some
 * information which WetHeatingMeasure shouldn't really have to know about.
 */
