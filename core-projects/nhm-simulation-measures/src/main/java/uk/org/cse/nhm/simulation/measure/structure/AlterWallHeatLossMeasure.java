...
public class AlterWallHeatLossMeasure extends AbstractMeasure implements IModifier<StructureModel> {
     ...
     * @throws NHMException
     * @see
     * uk.org.cse.nhm.simulator.measure.IComponentsAction#apply(IStateChangeSource,
     * IEvaluationContext, uk.org.cse.nhm.simulator.state.ISettableComponents,
     * ILets)
     */
    @Override
     ...
     * @return
     * @see
     * uk.org.cse.nhm.simulator.measure.IComponentsAction#isSuitable(IEvaluationContext,
     * uk.org.cse.nhm.simulator.state.IComponents)
     */
    @Override
