...
public class LightingProportionMeasureTest {
    ...
    @Mock
    private IDimension<StructureModel> strucDimension;

    @Mock
    private IComponentsFunction<Number> proportionOfCfl;
    @Mock
    private IComponentsFunction<Number> proportionOfIcandescent;
    @Mock
    private IComponentsFunction<Number> propotionOfHAL;
    @Mock
    private IComponentsFunction<Number> proportionOfLED;
    @Mock
    private IComponentsFunction<Number> proportionOfLVHal;
    @Mock
    private IComponentsFunction<Number> proportionOfAPlusPlus;

    @Mock
    private ITechnologyModel techModel;
    @Mock
    private StructureModel strModel;
    @Mock
    private EList<ILight> lights;
