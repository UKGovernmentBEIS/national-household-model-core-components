...
/**
 * A wrapper for an {@link IEnergyCalculatorParameters} which applies the little
 * tweaks that BREDEM specifies
 *
 * @author hinton
 *
 */
public class ParameterAdjustment implements IInternalParameters {
     ...
     * @param heatingPeriodAdjustment add this to the start time of each heating
     * period
     * @param heatingSystemZoneTwoTemperature set the zone two temperature to
     * this, overriding the unset value.
     */
