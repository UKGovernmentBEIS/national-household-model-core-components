...
class GainLoadRatioAdjuster implements IEnergyTransducer {
     ...
     * account for the variation in how much heating systems are on in warmer
     * months. For some reason, this scaling factor is also applied to internal
     * gains, in spite of the fact that (for example) solar gains in warmer
     * months will actually be larger. Anyway, this is not our assumption, but
     * it is odd.
     */
    @Override
