...
public enum EnergyCalculatorConstants implements IConstant {
	...
	*/
	...
	SOLAR_GAINS_OVERSHADING(new double[] {1.0, 0.77, 0.54, 0.3}),
	...
	*/
	...
	private EnergyCalculatorConstants(final double defaultValue) {
		this.defaultValue = defaultValue;
	}

	private EnergyCalculatorConstants(final double[] values) {
		defaultValue = 0;
