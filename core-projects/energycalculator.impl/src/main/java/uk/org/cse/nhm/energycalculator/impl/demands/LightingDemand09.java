...
/**
 * The CHM takes account of the external lighting in its lighting demand
 * calculation..
 * <p>
 * This could alternatively be an extra light source, which satisfies whatever
 * fraction of demand is satisfied by daylighting; depends on whether you think
 * of it as demand for
