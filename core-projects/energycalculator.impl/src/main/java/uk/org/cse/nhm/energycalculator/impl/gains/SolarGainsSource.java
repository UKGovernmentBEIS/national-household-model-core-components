...
/**
 * The energy transducer which provides solar gains; it sees
 * {@link IFabricElement}s through
 * {@link #addTransparentElement(IFabricElement)}, and accumulates their solar
 * gains; then when
 * {@link #generate(IEnergyState, IEnergyCalculatorParameters, ISpecificHeatLosses)}
 * is invoked the the accumulated gains are provided into the energy state.
 *
 * @author hinton
 *
 */
public class SolarGainsSource implements IEnergyTransducer {
    ...
    /**
     * The kind of gains this is producing from incident solar radiation.
     * Typically {@link EnergyType#BACKGROUND_GAINS_1} or two.
     */
