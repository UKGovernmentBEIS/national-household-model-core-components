...
/**
 * Each report builder may produce charts, data and resources. It may also
 * depend on {@link ILiberariesOutput} objects.
 *
 * @author richardt
 * @since 3.3.0
 */
public interface IReporterFactory {
    ...
    public interface IReporter extends Closeable {
        ...
        /**
         * @return the set of simulation log entry classes which this report
         * cares about
         */
