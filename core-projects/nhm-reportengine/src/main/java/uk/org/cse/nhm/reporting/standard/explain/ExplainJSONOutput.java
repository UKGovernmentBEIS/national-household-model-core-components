...
public class ExplainJSONOutput extends SizeRecordingReportOutput {
	...
	/**
	 * Because we remove the stock creation step, nodes may be left unconnected if there are no subsequent changes made to them.
	 * This method adds an edge to indicate that this group was unchanged during the scenario. 
	 */
