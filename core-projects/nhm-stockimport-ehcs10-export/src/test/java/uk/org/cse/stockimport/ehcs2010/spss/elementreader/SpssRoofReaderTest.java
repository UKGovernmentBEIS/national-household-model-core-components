...
public class SpssRoofReaderTest {
    ...
    /**
     * This test was constructed using the following unix pipeline to determine
     * the distinct combinations of the chm's roof type and the two survey
     * variables typercov and typerstr
