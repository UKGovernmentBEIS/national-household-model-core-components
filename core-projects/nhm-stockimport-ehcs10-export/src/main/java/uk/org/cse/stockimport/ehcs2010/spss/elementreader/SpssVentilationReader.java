...
public class SpssVentilationReader extends AbsSpssReader<IVentilationDTO> {
	 ...
	 *             system is a gas fire installed after 1975 according to the
	 *             CAR conversion document. We have extended this to also apply
	 *             to a secondary gas fire of unknown age in a house which was
	 *             built after 1975.
	 * 
	 * @param spaceHeating
	 * @return
	 ...
	 * </tr>
	 * <tr>
	 * Age bands H to K with habitable rooms <= 2
	 * <td></td>
	 * <td>1 fan</td>
	 * </tr>
	 * <tr>
	 * Age bands H to K with 3 <= habitable rooms <= 5
	 * <td></td>
	 * <td>2 fans</td>
	 * </tr>
	 * <tr>
	 * Age bands H to K with 6 <= habitable rooms <= 8
	 * <td></td>
	 * <td>3 fans</td>
	 * </tr>
	 * <tr>
	 * Age bands H to K with 9 <= habitable rooms
	 * <td></td>
	 * <td>4 fans</td>
	 * </tr>
	 * </table>
	 ...
	 *             house age band and the number of habitable rooms as specified
	 *             by SAP 2005 RDSAP table S5.
	 * 
	 * @param houseCase
	 * @param interior
	 * @return
