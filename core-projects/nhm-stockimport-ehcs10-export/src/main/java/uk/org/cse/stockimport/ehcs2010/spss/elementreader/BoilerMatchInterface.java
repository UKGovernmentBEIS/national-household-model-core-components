...
public class BoilerMatchInterface {
    ...
    public static FlueType nhmFromBoilerMatch(final uk.org.cse.boilermatcher.types.FlueType a) {
        ...
        switch (a) {
            ...
            case FAN_ASSISTED_BALANCED_FLUE:
    ...
    public static BoilerType nhmFromBoilerMatch(final uk.org.cse.boilermatcher.types.BoilerType a) {
        ...
        switch (a) {
            case CPSU:
                return BoilerType.CPSU;
            case INSTANT_COMBI:
                return BoilerType.INSTANT_COMBI;
            case REGULAR:
                return BoilerType.REGULAR;
            case STORAGE_COMBI:
    ...
    public static uk.org.cse.boilermatcher.types.FuelType nhmToBoilerMatch(final FuelType a) {
        ...
        switch (a) {
            case BULK_LPG:
                return uk.org.cse.boilermatcher.types.FuelType.BULK_LPG;
            case MAINS_GAS:
                return uk.org.cse.boilermatcher.types.FuelType.MAINS_GAS;
            case OIL:
                return uk.org.cse.boilermatcher.types.FuelType.OIL;
            default:
                return null;
        }
    }
    ...
    public static uk.org.cse.boilermatcher.types.FlueType nhmToBoilerMatch(final FlueType a) {
        ...
        switch (a) {
            case BALANCED_FLUE:
                return uk.org.cse.boilermatcher.types.FlueType.BALANCED_FLUE;
            case FAN_ASSISTED_BALANCED_FLUE:
                return uk.org.cse.boilermatcher.types.FlueType.FAN_ASSISTED_BALANCED_FLUE;
            case OPEN_FLUE:
                return uk.org.cse.boilermatcher.types.FlueType.OPEN_FLUE;
            default:
                return null;
        }
    }
    ...
    public static uk.org.cse.boilermatcher.types.BoilerType nhmToBoilerMatch(final BoilerType a) {
        ...
        switch (a) {
            case CPSU:
                return uk.org.cse.boilermatcher.types.BoilerType.CPSU;
            case INSTANT_COMBI:
                return uk.org.cse.boilermatcher.types.BoilerType.INSTANT_COMBI;
            case REGULAR:
                return uk.org.cse.boilermatcher.types.BoilerType.REGULAR;
            case STORAGE_COMBI:
                return uk.org.cse.boilermatcher.types.BoilerType.STORAGE_COMBI;
            case UNKNOWN:
                return uk.org.cse.boilermatcher.types.BoilerType.UNKNOWN;
            default:
                return null;
        }
    }
