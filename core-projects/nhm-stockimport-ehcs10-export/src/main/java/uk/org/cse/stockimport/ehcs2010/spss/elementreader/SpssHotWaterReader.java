...
/**
 * Converts Survey Data into {@link IWaterHeatingDTO}s for the builder to
 * process.
 *
 * @author hinton
 * @since 1.0
...
public class SpssHotWaterReader extends AbsSpssReader<IWaterHeatingDTO> {
    ...
    private final ILookup<FuelType, Double> hotWaterBoilerEfficiencyByFuel
            = DefaultLookup.of(
                    ImmutableMap.<FuelType, Double>builder()
                            ...
                            .build(),
                    /**
                     * Basic efficiency for hot-water only boilers not specified
                     * in the map {@link #hotWaterBoilerEfficiency}
                     */
                    0.65d);
    ...
    /**
     * @assumption All hot water boilers that aren't mains gas, bulk LPG, oil or
     * coal are 65% efficient.
     */
