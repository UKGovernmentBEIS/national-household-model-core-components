...
public class SpssRoofReader extends AbsSpssReader<IRoofDTO> {
     ...
     * will be fine for u-value lookups but may have a consequence for the
     * application of loft insulation in the simulation (as that tops-up from
     * the current value to a desired value)
     * @param survey
     * @return
     */
