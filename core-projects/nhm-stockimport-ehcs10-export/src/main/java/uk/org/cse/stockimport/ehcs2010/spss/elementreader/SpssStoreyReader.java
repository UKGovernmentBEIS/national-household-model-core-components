...
public class SpssStoreyReader extends AbsSpssReader<IStoreyDTO> {
    ...
    /**
     * Default ceiling height(meters) for room in roof see SAP 2005 RdSAP S3.6
     *
     * @since 1.0
     */
     ...
     *
     * @assumption If
     * {@link Physical_09Plus10EntryImpl#getDwellingType_DWTYPE8X()} is
     * converted flat and {@link ServicesEntry#getDwellingType()} is not ground
     * floor, mid floor or top floor flat, then assume the flat is on the ground
     * floor.
     *
     * @param shape
     * @param services
     ...
     * additional area, we create a square floor, i.e. total areas of main and
     * additional then sqrt to get infer dimensions.
     *
     *
     * @param locType
     * @param mainDepth
     ...
     * <li>If a floor has no additional width or depth, assume it is a
     * square.</li>
     ...
     * s
     *
     * @param floors {@link IStoreyDTO} objects to be harmonised
     * @since 0.0.1-SNAPSHOT
     */
     ...
     * <li> {@link InteriorEntry#getBathroomCeilingHeight_Metres_()}</li>
     * <li> {@link InteriorEntry#getBedroomCeilingHeight_Metres_()}</li>
     * </ul>
