...
/**
 * A device which tests an assertion about the direction and rate of change of a
 * particular quantity within a simulation.
 *
 * The test is evaluated at the end of each step, so changes that happen within
 * the first step will not be tested.
 *
 * @author hinton
 *
 */
