...
/**
 * Callback interface for a simulator to interface; implementors should register
 * themself with their {@link ITaskService} to get presented with jobs.
 *
...
public interface ISimulationExecutor {
     ...
     * @param scenarioSnapshot scenario to run
     * @param session session to log to and provide status to
