 ...
 *
 * Other lists may be branched off of this one in an efficient manner (wthout
 * performing a copy). Lists become invalid if their parent list changes or
 * becomes invalid after they branch.
 *
 * @since 1.1.2
 */
