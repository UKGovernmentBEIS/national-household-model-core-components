 ...
 * for example
 *
 * (generate-combinations [a b c] [d e f])
 *
 * expands to
 *
 ...
 *
 * (generate-combinations template:(do all:true @rest)
 *
 * [a b c] [d e f])
 *
 * expands to
 *
 * (do all:true a d) (do all:true a e) (do all:true a f) (do all:true b d) (do
 * all:true b e) (do all:true b f) (do all:true c d) (do all:true c e) (do
 * all:true c f)
 *
 * and so on.
 *
