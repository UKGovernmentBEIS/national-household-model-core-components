...
public class HeatingEfficiencyFunction extends AbstractNamed implements IComponentsFunction<Double> {
    ...
    /**
     * Work out the in-situ efficiency of a system based on the demand it
     * satisfied divided by the fuel it used to do so.
     */
     ...
     *
     * If the primary system is present and not broken, we used that. Otherwise,
     * we used the secondary system.
     *
