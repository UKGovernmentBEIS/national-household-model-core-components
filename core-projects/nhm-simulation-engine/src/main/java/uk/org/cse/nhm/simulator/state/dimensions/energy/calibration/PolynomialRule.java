...
/**
 * This is a rule which computes a simple polynomial; since this is likely to be
 * used for calibration more than the more generic option, it makes sense to
 * special-case it out and make it fast.
 *
 * @author hinton
 *
 */
