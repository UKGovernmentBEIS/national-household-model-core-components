...
public class Condition {
    ...
    public interface IConditionListener {
         ...
         *
         * @param groups
         * @param gained indexed by groups, this is how many new houses entered
         * each group
         * @param lost indexed by groups, this is how many previously contained
    ...
    public Condition(final ICanonicalState state,
        ...
        state.addStateListener(new IStateListener() {
            ...
            public void stateChanged(final ICanonicalState state, final IStateChangeNotification notification) {
                ...
                dwellings:
                for (final IDwelling d : notification.getChangedDwellings(getDependencies())) {
    ...
    /**
     * The {@link IDwellingGroup} implementation that {@link Condition} builds.
     *
     * @author hinton
     *
     */
    static class Group extends BaseDwellingGroup implements IConditionGroup {
         ...
         * group (so we can break out early), or {@link Change#NEWLY_CONTAINED}
         * if d was not in this group but now is (so that subsequent groups need
         * to be updated to not contain d).
         */
