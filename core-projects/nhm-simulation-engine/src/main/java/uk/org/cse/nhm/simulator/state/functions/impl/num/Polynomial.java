...
/**
 * A function which evaluates a "variable" function x, and then uses a sequence of other functions
 * to compute the coefficients of terms in a polynomial on x.
 * 
 * @author hinton
 *
 */
public class Polynomial extends AbstractNamed implements IComponentsFunction<Double> {
	...
	/**
	 * The sequence of functions on which this depends. The first function computes
	 * the "x" value, and subsequent functions are used to compute the coefficients of
	 * x^0, x^1, and so on.
	 * 
	 * @param values
	 */
