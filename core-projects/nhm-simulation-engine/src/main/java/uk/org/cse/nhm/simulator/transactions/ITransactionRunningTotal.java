...
/**
 * We don't want to keep all the historical transactions for performance
 * reasons. Instead, ask this class for a particular calculation at the start of
 * the simulation, and it will keep it up to date.
 */
