...
/**
 * A basic implementation of the trigger interface; the only logic in this is in
...
public abstract class TimedTrigger extends AbstractNamed implements ITrigger, IDateRunnable, Initializable {
    ...
    public void run(final DateTime date) throws NHMException {
        ...
        if (log.isInfoEnabled()) {
            log.info("{} applied to {} of {} instances", new Object[]{this, applyTo.size(), group.getContents().size()});
        }
