...
/**
 * Used to store "flags" associated with a dwelling, which are basically named boolean variables accesible and creatable
 * by end users through the scenario.
 * 
 * @author hinton
 *
 */
public interface IFlags extends ICopyable<IFlags> {
	...
	/**
	 * @return The value stored against the named register, or 0 if none could be found.
	 */
