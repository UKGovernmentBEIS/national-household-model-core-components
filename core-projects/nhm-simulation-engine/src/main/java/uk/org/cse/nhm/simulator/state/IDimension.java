 ...
 * An {@link IDwelling} has various data associated with it in an {@link IState},
 * which are grouped together under an {@link IDimension}.
 * 
 * @author hinton
 *
...
public interface IDimension<T> {
	...
	/**
	 * @return true if this dimension is in-principle something which can be changed
	 * directly
	 */
