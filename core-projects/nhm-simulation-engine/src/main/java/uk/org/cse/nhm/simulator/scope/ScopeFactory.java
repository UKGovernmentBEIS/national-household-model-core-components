...
public class ScopeFactory {
	 ...
	 * @param branch
	 * @param dwelling
	 * @param yields - this argument will be shared with the resulting scope; no defensive copy is taken, so think carefully
	 * @return
	 */
	 ...
	 * @param branch
	 * @param dwelling
	 * @param yields - this argument will be shared with the resulting scope, without a defensive copy
	 * @return
	 */
