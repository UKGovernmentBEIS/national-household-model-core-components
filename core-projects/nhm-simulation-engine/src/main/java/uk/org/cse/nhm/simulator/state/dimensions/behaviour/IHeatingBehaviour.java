...
public interface IHeatingBehaviour extends ICopyable<IHeatingBehaviour> {
    ...
    /**
     * This value does not mean the same thing as
     * {@link #getLivingAreaDemandTemperature()} - {@link #getSecondAreaDemandTemperature()};
     * one of the quirks of SAP is that you can either define the second area
     * demand temperature OR you can define a difference and then it uses some
     * process to work out the actual second area demand temperature to be used;
     * this value is more like an aspiration, whereas
     * {@link #getSecondAreaDemandTemperature()} actually forces the value.
     *
     * @return the temperature difference between living area and rest of
     * dwelling, if present
     */
    public Optional<Double> getTemperatureDifference();

    /**
     * @return the rest-of-dwelling demand temperature, if set. See also
     * {@link #getTemperatureDifference()}.
     */
    public Optional<Double> getSecondAreaDemandTemperature();

    /**
     * Construct a new heating behaviour like this one but with the given
     * temperature
     *
     * @param d
     * @return
    ...
    /**
     * Set the demand temperature in the rest of the dwelling; this implicitly
     * unsets the temperature difference, as they are mutually exclusive.
     *
     * @param temperature
     */
    ...
    /**
     * Set the desired temperature difference between living area and rest of
     * dwelling; this implicitly unsets the demand temperature in rest of
     * dwelling, as they are mutually exclusive.
     *
