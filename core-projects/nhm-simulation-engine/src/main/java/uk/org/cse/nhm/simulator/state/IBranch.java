...
/**
 * An {@link IBranch} is a non-canonical description of a state which is
 * different to the canonical state.
 *
 * @author hinton
 *
 */
public interface IBranch extends IState {
    ...
    /**
     * Change this hypothetical so that the given dimension of the given
     * instance takes the given value.
     *
     * @param dimension
     * @param instance
     * @param value
    ...
    /**
     * @return a new {@link IDwelling} that will exist within this state and any
     * branches from it
     */
    public IDwelling createDwelling(final float weight);

    /**
     * @param lenny remove the given {@link IDwelling} from the set of all that
     * exist, in this state
     */
    ...
    /**
     * @return true if this is a hypothetical, in which case it is not legal to
     * merge it
     */
    public boolean isHypothetical();

    /**
     * Fold a branch state from a sequence of {@link #branch(int)} calls back
     * onto this.
     *
     * @param branch
     * @param cause TODO
