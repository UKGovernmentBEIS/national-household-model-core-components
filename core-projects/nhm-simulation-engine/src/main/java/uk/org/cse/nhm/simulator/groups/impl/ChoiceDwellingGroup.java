...
/**
 * This is a group which chooses a fixed proportion of the elements which are
 * added to its source group.
 *
 * It does /not/ ensure that it is always a fixed proportion of the source,
 * because of the possibility that elements are removed from the source in a
 * disproportionate way.
 *
 * Optionally it can be configured as a one-shot group which only responds to
 * the first update from its source.
 *
 * @author tomh
...
public class ChoiceDwellingGroup extends BaseDwellingGroup {
    ...
    /**
     * The builder can use this method to set up the group once all other sim
     ...
     * @param oneShot if this is true, this will select a random proportion from
     * the first update to the source group, and stay the same thereafter.
     */
