...
public interface ITariffs extends ICopyable<ITariffs>, Iterable<ITariff> {
	...
	/**
	 * go on the given tariffs if legal; if illegal (there would be more than one tariff per fuel
	 * either in the input or in the result) there will be an illegal argument exception.
	 * 
	 * @param tariff
	 */
	...
	/**
	 * @param tariffs
	 * @return true if {@link #adoptTariffs(Set)} would not throw an exception for this set.
	 */
	...
	/**
	 * Removes a particular extra charge if it was previously added, otherwise does nothing.
