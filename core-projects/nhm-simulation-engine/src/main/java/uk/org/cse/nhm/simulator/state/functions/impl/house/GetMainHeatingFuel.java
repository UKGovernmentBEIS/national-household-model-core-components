    ...
    private XFuelType convert(final FuelType fuel) {
        ...
        switch (fuel) {
            case BIOMASS_PELLETS:
                return XFuelType.BiomassPellets;
            case BIOMASS_WOOD:
                return XFuelType.BiomassWood;
            case BIOMASS_WOODCHIP:
                return XFuelType.BiomassWoodchip;
            case BOTTLED_LPG:
                return XFuelType.BottledLPG;
            case BULK_LPG:
                return XFuelType.BulkLPG;
            case COMMUNITY_HEAT:
                return XFuelType.CommunityHeat;
            case ELECTRICITY:
                return XFuelType.Electricity;
            case EXPORTED_ELECTRICITY:
                return XFuelType.ExportedElectricity;
            case HOUSE_COAL:
                return XFuelType.HouseCoal;
            case MAINS_GAS:
                return XFuelType.MainsGas;
            case OFF_PEAK_ELECTRICITY:
                return XFuelType.OffPeakElectricity;
            case OIL:
                return XFuelType.Oil;
            case PEAK_ELECTRICITY:
                return XFuelType.PeakElectricity;
            case PHOTONS:
                return XFuelType.Photons;
            default:
