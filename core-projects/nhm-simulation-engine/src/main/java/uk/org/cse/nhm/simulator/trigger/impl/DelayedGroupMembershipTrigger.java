...
/**
 * A trigger which listens to its group, and fires its action on all elements
 * added to the group after a specified delay (settable through
 * {@link #setDelay(Period)}).
 *
 * @author hinton
 *
 */
