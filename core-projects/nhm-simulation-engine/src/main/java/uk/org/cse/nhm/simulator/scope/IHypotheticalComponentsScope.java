...
/**
 * A special kind of components scope for imagining things in; designed for use
 * by NPV and other hallucinations
 *
 * @since 3.8.0
 */
public interface IHypotheticalComponentsScope extends ISettableComponentsScope {
    ...
    /**
     * Directly replace one dimension with another. This will create a shim
     * internally which ensures that the generation numbers for things do not
     * end up decreasing, so you don't have to worry about that.
     *
     * @param dimension
     * @param internal
     */
