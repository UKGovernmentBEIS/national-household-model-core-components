...
public class StateModule extends AbstractModule {
    ...
    protected void configure() {
         ...
         */
        final Multibinder<IDimension<?>> copyDimensions = Multibinder.newSetBinder(binder(), new TypeLiteral<IDimension<?>>() {
        }, Names.named(IDimension.CONSTRUCT_COPY));
        ...
        installDimension(new StandardDimensionModule<People>("People") {
        }).bindDimension(dimensions)
                .bindDimension(copyDimensions)
                .bindInternal(internalDimensions);
        ...
        bind(new TypeLiteral<IDimension<IEnergyMeter>>() {
        }).to(EnergyMeterDimension.class);
...

        {
            install(
                ...
                protected void configure() {
                    ...
                    bind(new TypeLiteral<IComponentsFunction<IWeather>>() {
                    }).toInstance(ConstantComponentsFunction.of(
                            Name.of("SAP Weather"),
        ...
        }
        {
            install(
                ...
                protected void configure() {
                    ...
                    bind(new TypeLiteral<IComponentsFunction<ICarbonFactors>>() {
                    }).toInstance(ConstantComponentsFunction.of(
                            Name.of("SAP Carbon"),
        ...
        bind(new TypeLiteral<IDimension<ITime>>() {
        }).to(RealTimeDimension.class);
        ...
        bind(new TypeLiteral<IDimension<IEmissions>>() {
        }).to(EmissionsDimension.class);
