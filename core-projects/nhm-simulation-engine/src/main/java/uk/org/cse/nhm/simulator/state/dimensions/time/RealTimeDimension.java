...
/**
 * This time dimension implementation keeps track of the real time, which is the same whoever's asking.
 * It is the variation that is going to be in almost all places in the simulation, and by and large there is only
 * ever one instance of it.
 * 
 * In some hypoethetical circumstances, the {@link SurrealTimeDimension} will be emplaced on top of this, allowing
