 ...
 * java.util.random to provide some extra features: 1. the random state can be
 * changed after construction 2. there are convenience methods for shuffling and
 * picking 3. the random algorithm is a better one (XORShift due to George
 * Marsaglia)
 */
public class RandomSource extends Random {
    ...
    /**
     * Utility to select something from a list of options, weighted by some
     * weights.
     */
    ...
    /**
     * Randomly draw a population of items from input so that their total weight
     * under the weight function is around the given amount, placing them into
     * output. This is statistically correct in the limit of the weight of each
     * thing being very small and the number being very large.
     */
