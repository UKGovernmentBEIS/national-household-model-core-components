...
/**
 * So, this is a special action which sometimes does odd things regarding its
 * values
 */
public class SequenceAction extends AbstractNamed implements IComponentsAction {
    ...
    /**
     * If we have several actions and only the first one can fail, we don't need
     * an isolating branch
     *
     * @param delegates2
     */
    ...
    /**
     * We are always suitable if (a) we do not require success (b) we do require
     * success, but all our delegates are always suitable
     *
