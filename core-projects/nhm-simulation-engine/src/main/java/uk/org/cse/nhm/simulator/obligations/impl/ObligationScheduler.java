...
/**
 * This class watches for the addition of obligations to dwellings, and invokes
 * those obligations {@link IObligation#handle(IDwelling)} methods.
 *
...
public class ObligationScheduler implements IStateListener, Initializable {
    ...
    /**
     * Tracks the number of obligations for each dwelling that we have
     * processed; when a dwelling is changed, we will only consider scheduling
     * obligations that are added after this point
     */
