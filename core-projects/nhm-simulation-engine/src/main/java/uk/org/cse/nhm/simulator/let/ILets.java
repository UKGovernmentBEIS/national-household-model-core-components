 ...
 * effectively a hierarchy of immutable maps; the way to add to a let
 * is through {@link #withBinding(Object, Object)} or {@link #withBindings(Map)}.
 * 
 * @author hinton
 *
 */
public interface ILets {
	...
	/**
	 * Create a new lets, adding the additional map of things to the bindings
	 * in this one
	 * @param additions
	 * @return
	 */
