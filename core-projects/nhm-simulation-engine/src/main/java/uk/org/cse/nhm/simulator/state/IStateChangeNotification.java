...
public interface IStateChangeNotification {
    ...
    /**
     * @return a set of all of the dwellings that have been modified in this
     * change, in their modified states
     */
    ...
    /**
     * @return the scope which holds all the result data for this state change
     * event.
     */
    ...
    /**
     * @return true if anything is altered, created, or destroyed in this
     * change.
     */
    boolean isChange();
     ...
     * {@link #getRootScope()}.getComponentsScope(dwelling).get().getAllNotes(clazz);
     *
     * @param dwelling
     * @param clazz
     * @return
