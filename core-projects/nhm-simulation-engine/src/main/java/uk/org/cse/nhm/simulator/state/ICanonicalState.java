...
/**
 * An extension to {@link IState} providing listener methods, as only the
 * canonical state notifies listeners
 *
 * @author hinton
 *
 */
public interface ICanonicalState extends IState {
     ...
     * there may be endogenous changes in the various dimensions that are
     * related to time e.g. fuel, weather, etc.
     */
