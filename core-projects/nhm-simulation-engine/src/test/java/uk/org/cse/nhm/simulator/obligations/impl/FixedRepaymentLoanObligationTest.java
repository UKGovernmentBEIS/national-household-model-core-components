...
public class FixedRepaymentLoanObligationTest {
    ...
    public void testAnnualRepaymentWithTilt() {
        /**
         * These are the first year repayments for a loan of 1 with a term of
         * (array index+1) taken from the spreadsheet provided by DECC.
         *
         * Since our implementation is independently derived, the fact that this
         * test passes is indicative of it being right; note that the
         * spreadsheet contains an error due to the failure to apply l'hopital's
         * rule when interest rate = tilt rate.
         */
