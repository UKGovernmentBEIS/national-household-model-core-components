...
public class LogEntryTestUtility {
	 ...
	 * <br />
	 * Note the object mapper has been configured to include type information (Java class name)
	 * in the JSON enabling us to deserialise concrete implementations to the interface
	 * they all implement and successfully compare against the original concrete instance.
