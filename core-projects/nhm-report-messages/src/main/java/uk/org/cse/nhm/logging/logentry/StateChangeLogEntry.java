...
/**
 * A log entry for state change events - at the end of a simulation timestep
 * (i.e. a batch of contemporaneous events), one of these will be logged for
 * each dwelling whose state has changed, describing the new state of the
 * dwelling
 *
 * @author hinton
 *
