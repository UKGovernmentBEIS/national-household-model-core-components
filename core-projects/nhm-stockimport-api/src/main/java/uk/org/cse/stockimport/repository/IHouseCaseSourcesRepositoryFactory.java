...
public interface IHouseCaseSourcesRepositoryFactory {
    ...
    /**
     * Returns a provider containing collections of objects specified in
     * objectsToProvide, stored under AA code keys.
     *
     * @param objectsToProvide a set of object defined by class name that should
     * be provided within the iterator
