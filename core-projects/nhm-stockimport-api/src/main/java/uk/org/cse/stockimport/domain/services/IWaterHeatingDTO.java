...
/**
 * Defines the DTO for domestic hot water (DHW) systems. In the overwhelming
 * majority of cases, DHW is provided by a connection to the main space heating
 * system, which is indicated by the {@link #isWithCentralHeating()} method. In
 * such cases, most of the attributes of the DTO are not requried, as they are
 * given by attributes of the main heating system.
 *
 * @author hinton
 * @since 1.0
 */
