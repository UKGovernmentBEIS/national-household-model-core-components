...
/**
 * Thing for determining properties of windows, according to SAP and RDSAP
 * rules.
 *
 * @author hinton
 * @since 1.0
...
public interface IWindowPropertyImputer {
    ...
    /**
     * Get the U value for a window of the given glazing type, for a property
     * constructed in the given interval
     *
     * @param glazingType
