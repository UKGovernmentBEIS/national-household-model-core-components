...
public interface IWallPropertyImputer {
    ...
    /**
     * Get the U-value for a wall based on these attributes for the wall and the
     * property
     *
     ...
     * @param insulationThicknesses a map from applied insulation types to
     * thicknesses in mm
     * @param wallThickness thickness of the wall, or zero if missing or
     * whatever.
     ...
     *
     * Use
     * {@link #getWallThickness(DateTime, DateTime, RegionType, WallConstructionType, Set)}
     * to get thickness.
     *
     * @param earliestBuild earliest possible build date for the house
     * @param latestBuild latest possible build date for the house
