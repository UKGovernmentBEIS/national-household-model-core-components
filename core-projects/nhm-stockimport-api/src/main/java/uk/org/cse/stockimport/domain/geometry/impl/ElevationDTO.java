 ...
 * ElevationDTO.
 *
 * @assumption CHM does not compute roof windows are either not applicable or
 * zero.
 * @assumption CHM has default imputation values for window
 * orientation(east/west) and over shading(average/unknown)
 *
 * @author richardt
...
public class ElevationDTO extends AbsDTO implements IElevationDTO {
    ...
    /**
     * @return @see
     * uk.org.cse.stockimport.domain.geometry.IElevationDTO#getAngleFromNorth()
     */
    @Override
     ...
     * @see
     * uk.org.cse.stockimport.domain.geometry.IElevationDTO#setAngleFromNorth(com.google.common.base.Optional)
     */
    @Override
