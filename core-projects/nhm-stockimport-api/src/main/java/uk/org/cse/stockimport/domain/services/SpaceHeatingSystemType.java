...
/**
 * A representation of Table 5 in the CHM conversion document, detailing the
 * types of system which the CHM understands.
 *
 * This is a combination of {@link BasicSpaceHeatingSystemType} with some other
 * attributes; you can use {@link #getBasicType()} to get the associated
 * {@link BasicSpaceHeatingSystemType}
 *
 * @author hinton
 * @since 1.0
 */
public enum SpaceHeatingSystemType {
    ...
    /**
     * @assumption Community heating assumed to use mains gas as specified by
     * CHM Converting English Housing Survey document.
     */
    COMMUNITY_HEATING_WITHOUT_CHP(COMMUNITY, UNKNOWN),
    COMMUNITY_HEATING_WITH_CHP(COMMUNITY, UNKNOWN),
    /**
     * @assumption Biomass boiler assumed to use Biomass Pellets based on CHM
     * spreadsheet worksheet:Building Physics Parameters, cell: I1012
     */
    ...
    /**
     * Finds a SpaceHeatingSystemType which matches the given BoilerType and
     * FuelType. Always returns Absent if the boiler type is unknown. There
