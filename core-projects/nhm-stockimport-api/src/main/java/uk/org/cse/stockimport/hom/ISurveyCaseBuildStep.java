...
public interface ISurveyCaseBuildStep {
	...
	/**
	 * @return the names of other build steps which need already to have happened for this to work.
     * @since 1.0
	 */
	public Set<String> getDependencies();
	
	/**
	 * Run this build step; update the given object model using the associated DTO provider.
	 * 
	 * @param model
	 * @param dtoProvider
     * @since 1.0
