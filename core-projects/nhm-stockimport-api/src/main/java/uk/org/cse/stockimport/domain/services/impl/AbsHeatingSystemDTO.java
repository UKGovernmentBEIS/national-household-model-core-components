...
public abstract class AbsHeatingSystemDTO extends AbsDTO implements IHeatingDTO {
    ...
    /**
     * @return @see
     * uk.org.cse.stockimport.domain.services.ISpaceHeatingDTO#getPcdbMatch()
     */
    @Override
     ...
     * @param isMatch
     * @see
     * uk.org.cse.stockimport.domain.services.ISpaceHeatingDTO#setPcdbMatch(com.google.common.base.Optional)
     */
    @Override
