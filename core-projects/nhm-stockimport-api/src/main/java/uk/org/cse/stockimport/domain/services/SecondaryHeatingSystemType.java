...
/**
 * Based on the Secondary Heating System lookup table from the 2010 Cambridge
 * Housing Model spreadsheet, Phyiscs Parameters worksheet.
 *
 * To this we have added: LPG heater since we have a separate fuel type for
 * this. Open flue gas fire as we think it is better to use this data rather
