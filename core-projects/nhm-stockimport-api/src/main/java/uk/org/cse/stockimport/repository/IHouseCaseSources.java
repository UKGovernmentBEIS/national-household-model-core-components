...
/**
 * An interface encapsulating a collection of {@link IBasicDTO} implementations, which all associate to the same
 * AA Code.
 * 
 * @author hinton
 * @since 1.0
...
public interface IHouseCaseSources<Q> {
	...
	/**
	 * Convenience method for getting a single value; this is equivalent to
	 * <code>
	 * 	getAll(clazz).get(0)
	 * </code>
	 * with associated null value / multiple value checks.
	 * 
	 * @param clazz
	 * @return a single {@link IBasicDTO} implementation which implements the given class.
	 * @throws IllegalArgumentException if there is more than one DTO for the given class.
	 * @since 1.0
	 */
	...
	/**
	 * @param clazz
	 * @return a list of all the {@link IBasicDTO} implementations which implement the given class.
	 * @since 1.0
	 */
