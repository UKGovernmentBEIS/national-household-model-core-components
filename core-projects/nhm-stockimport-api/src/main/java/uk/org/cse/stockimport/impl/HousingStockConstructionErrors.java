...
/**
 * Contains all the errors that occurred during the house construction
 * phase of the stock import. This captures the errors that will have
 * prevented survey cases from being constructed and stored.
 * 
 * @since 4.0.0
 */
