 ...
 *
 * If you use this module, you need to pass in a {@link SimulationParameter} to
 * the builder which will seed the binding for
 * {@link HousePropertyStoreRepository} when you run a sim.
 *
 * @author hinton
 *
 */
