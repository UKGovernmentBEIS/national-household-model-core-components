...
public class StorageHeaterBuilder implements IStorageHeaterBuilder {
    ...
    @Override
    /**
     * @assumption If storage heater type is unknown, OLD_LARGE_VOLUME is
     * presumed.
     * @assumption Fan storage heaters have celect charge control, others have
     * manual, unless specified by the dto.
     */
