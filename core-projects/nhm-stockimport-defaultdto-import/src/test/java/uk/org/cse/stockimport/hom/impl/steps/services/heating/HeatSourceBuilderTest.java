 ...
 *
 * This test is overspecific in a lot of places, expecting specific boiler
 * interface implementations but that is OK. Better to have an overspecific test
 * than a test that doesn't fail when it should
 *
 * @author hinton
 *
 */
