...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>boilers</b></em>' package.
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class BoilersExample {
    ...
    public static void main(String[] args) {
        ...
        //
        resourceSet.getPackageRegistry().put(IBoilersPackage.eNS_URI,
        ...
        if (args.length == 0) {
            ...
            try {
                Resource resource = resourceSet.createResource(URI.createURI("http:///My.boilers"));
                IBoiler root = IBoilersFactory.eINSTANCE.createBoiler();
