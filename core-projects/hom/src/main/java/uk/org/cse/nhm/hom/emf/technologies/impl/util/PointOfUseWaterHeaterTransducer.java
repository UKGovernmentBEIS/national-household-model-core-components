...
/**
 * A utility class associated with {@link PointOfUseWaterHeaterImpl} which is
 * supplied into the energy calculation to satisfy some hot water demand in the
 * manner of a point of use water heater.
 *
 * @author hinton
 *
 */
