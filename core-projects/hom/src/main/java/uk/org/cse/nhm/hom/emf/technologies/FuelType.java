...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Fuel
...
public enum FuelType implements Enumerator {
     ...
     * <!-- begin-user-doc -->
     * You should <b>not</b> directly set this as the fueltype for any system
     * that consumes electricity. This is only here for accounting purposes. To
     * specify a device as electrical, use {@link #ELECTRICITY} instead.
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Bottled LPG</b></em>' literal object isn't
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Oil</b></em>' literal object isn't clear, there
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Biomass Pellets</b></em>' literal object isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Biomass Woodchip</b></em>' literal object isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Biomass Wood</b></em>' literal object isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>House Coal</b></em>' literal object isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Community Heat</b></em>' literal object isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Peak Electricity</b></em>' literal object isn't
     * clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Off Peak Electricity</b></em>' literal object
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Exported Electricity</b></em>' literal object
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * A public read-only list of all the '<em><b>Fuel Type</b></em>'
     * enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the '<em><b>Fuel Type</b></em>' literal with the specified
     * literal value.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    public static FuelType get(int value) {
        switch (value) {
            case MAINS_GAS_VALUE:
                return MAINS_GAS;
            case BULK_LPG_VALUE:
                return BULK_LPG;
            case BOTTLED_LPG_VALUE:
                return BOTTLED_LPG;
            case ELECTRICITY_VALUE:
                return ELECTRICITY;
            case OIL_VALUE:
                return OIL;
            case BIOMASS_PELLETS_VALUE:
                return BIOMASS_PELLETS;
            case BIOMASS_WOODCHIP_VALUE:
                return BIOMASS_WOODCHIP;
            case BIOMASS_WOOD_VALUE:
                return BIOMASS_WOOD;
            case PHOTONS_VALUE:
                return PHOTONS;
            case HOUSE_COAL_VALUE:
                return HOUSE_COAL;
            case COMMUNITY_HEAT_VALUE:
                return COMMUNITY_HEAT;
            case PEAK_ELECTRICITY_VALUE:
                return PEAK_ELECTRICITY;
            case OFF_PEAK_ELECTRICITY_VALUE:
                return OFF_PEAK_ELECTRICITY;
            case EXPORTED_ELECTRICITY_VALUE:
                return EXPORTED_ELECTRICITY;
        }
        return null;
    }
    ...
    /**
     * @return the {@link EnergyType} corresponding to this fuel type in a
     * community system. The distinction is required so that we can account for
     * CO2 emissions of community systems but allow the household to pay for the
     * heat they are supplied directly.
     */
    ...
    /**
     * @return the {@link EnergyType} corresponding to this {@link FuelType},
     * for use in the energy calculation.
     */
