 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#getStore
 * <em>Store</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#isStoreInPrimaryCircuit
 * <em>Store In Primary Circuit</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#isPrimaryPipeworkInsulated
 * <em>Primary Pipework Insulated</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#isSeparatelyTimeControlled
 * <em>Separately Time Controlled</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#getSolarWaterHeater
 * <em>Solar Water Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#getPrimaryWaterHeater
 * <em>Primary Water Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#getSecondaryWaterHeater
 * <em>Secondary Water Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralWaterSystemImpl#getTechnologyModel
...
public class CentralWaterSystemImpl extends WaterHeaterImpl implements ICentralWaterSystem {
    ...
    /**
     * The cached value of the '{@link #getStore() <em>Store</em>}' containment
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isStoreInPrimaryCircuit() <em>Store In
     * Primary Circuit</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isStoreInPrimaryCircuit()
    ...
    /**
     * The default value of the '{@link #isPrimaryPipeworkInsulated()
    ...
    /**
     * The flag representing the value of the '{@link #isPrimaryPipeworkInsulated()
     * <em>Primary Pipework Insulated</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isSeparatelyTimeControlled()
    ...
    /**
     * The flag representing the value of the '{@link #isSeparatelyTimeControlled()
     * <em>Separately Time Controlled</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getSolarWaterHeater() <em>Solar Water
    ...
    /**
     * The cached value of the '{@link #getPrimaryWaterHeater() <em>Primary
     * Water Heater</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getSecondaryWaterHeater() <em>Secondary
     * Water Heater</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    public void setStoreInPrimaryCircuit(boolean newStoreInPrimaryCircuit) {
        ...
        if (newStoreInPrimaryCircuit) {
            flags |= STORE_IN_PRIMARY_CIRCUIT_EFLAG;
        } else {
            flags &= ~STORE_IN_PRIMARY_CIRCUIT_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    public void setPrimaryPipeworkInsulated(boolean newPrimaryPipeworkInsulated) {
        ...
        if (newPrimaryPipeworkInsulated) {
            flags |= PRIMARY_PIPEWORK_INSULATED_EFLAG;
        } else {
            flags &= ~PRIMARY_PIPEWORK_INSULATED_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    public void setSeparatelyTimeControlled(boolean newSeparatelyTimeControlled) {
        ...
        if (newSeparatelyTimeControlled) {
            flags |= SEPARATELY_TIME_CONTROLLED_EFLAG;
        } else {
            flags &= ~SEPARATELY_TIME_CONTROLLED_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    public ITechnologyModel getTechnologyModel() {
        if (eContainerFeatureID() != ITechnologiesPackage.CENTRAL_WATER_SYSTEM__TECHNOLOGY_MODEL) {
            return null;
        }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == IStoreContainer.class) {
            switch (derivedFeatureID) {
                case ITechnologiesPackage.CENTRAL_WATER_SYSTEM__STORE:
                    return ITechnologiesPackage.STORE_CONTAINER__STORE;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == IStoreContainer.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.STORE_CONTAINER__STORE:
                    return ITechnologiesPackage.CENTRAL_WATER_SYSTEM__STORE;
                default:
                    return -1;
            }
        }
    ...
    public FuelType getFuel() {
        ...
        type = getPrimaryFuel();
        if (type == null) {
            type = getSecondaryFuel();
        }
        if (type == null && hasImmersionHeater()) {
