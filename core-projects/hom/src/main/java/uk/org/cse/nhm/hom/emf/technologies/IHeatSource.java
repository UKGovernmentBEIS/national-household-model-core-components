 ...
 *
 * <!-- begin-model-doc -->
 * A heat source is a device (like a boiler, or community heating heat exchanger) which can provide heat to wet heating and hot water systems. On its own, the device does nothing - it needs to be connected to a central heating system and/or a central hot water system to work.
 * <!-- end-model-doc -->
 *
 * <p>
...
public interface IHeatSource extends IFuelAndFlue, IOperationalCost, IHasInstallationYear {
	 ...
	 * @see uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getHeatSource_WaterHeater()
	...
	/**
	 * Sets the value of the '{@link uk.org.cse.nhm.hom.emf.technologies.IHeatSource#getWaterHeater <em>Water Heater</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Space Heater</b></em>' reference.
	 * It is bidirectional and its opposite is '{@link uk.org.cse.nhm.hom.emf.technologies.ICentralHeatingSystem#getHeatSource <em>Heat Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getHeatSource_SpaceHeater()
	...
	/**
	 * Sets the value of the '{@link uk.org.cse.nhm.hom.emf.technologies.IHeatSource#getSpaceHeater <em>Space Heater</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * This method will be invoked by the central heating system, if this heat source is
	 * connected to the central heating system. The heat source should use it to provide a heat
	 * transducer to the visitor.
	 * <!-- end-model-doc -->
	 * @model constantsDataType="uk.org.cse.nhm.hom.emf.technologies.IConstants" constantsRequired="true" parametersDataType="uk.org.cse.nhm.hom.emf.technologies.IEnergyCalculatorParameters" parametersRequired="true" visitorDataType="uk.org.cse.nhm.hom.emf.technologies.IEnergyCalculatorVisitor" visitorRequired="true" proportionRequired="true" priorityRequired="true"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The responsiveness value returned from this method is used by a connected heating system
	 * to determine the background temperature in the house
	 * <!-- end-model-doc -->
	 * @model required="true" parametersDataType="uk.org.cse.nhm.hom.emf.technologies.IConstants" parametersRequired="true" controlsMany="true" controlsOrdered="false" emitterTypeRequired="true"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * A connected central heating system will use this method to adjust the house's demand temperature
	 * <!-- end-model-doc -->
	 * @model required="true" parametersDataType="uk.org.cse.nhm.hom.emf.technologies.IInternalParameters" parametersRequired="true" controlTypesMany="true" controlTypesOrdered="false"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * If connected to central hot water, this method will be invoked by the central hot water system
	 * to account for the distribution losses in that system; distribution losses are allocated to
	 * water heaters <em>pro rata</em> the amount of hot water generated
	 * <!-- end-model-doc -->
	 * @model parametersDataType="uk.org.cse.nhm.hom.emf.technologies.IInternalParameters" parametersRequired="true" stateDataType="uk.org.cse.nhm.hom.emf.technologies.IEnergyState" stateRequired="true" storeIsPrimaryRequired="true" systemLossesRequired="true"
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" parametersDataType="uk.org.cse.nhm.hom.emf.technologies.IInternalParameters" parametersRequired="true" storeRequired="true" storeInPrimaryCircuitRequired="true"
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * Some heat sources contain a storage tank of some kind (like CPSUs) - the hot water system
	 * will invoke this method to get the tank losses associated with this tank.
	 * <!-- end-model-doc -->
