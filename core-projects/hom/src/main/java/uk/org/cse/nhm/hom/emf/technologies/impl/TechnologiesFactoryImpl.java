...
public class TechnologiesFactoryImpl extends EFactoryImpl implements ITechnologiesFactory {
    ...
    public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            case ITechnologiesPackage.TECHNOLOGY_MODEL:
                return createTechnologyModel();
            case ITechnologiesPackage.APPLIANCE:
                return createAppliance();
            case ITechnologiesPackage.LIGHT:
                return createLight();
            case ITechnologiesPackage.CENTRAL_WATER_SYSTEM:
                return createCentralWaterSystem();
            case ITechnologiesPackage.CENTRAL_HEATING_SYSTEM:
                return createCentralHeatingSystem();
            case ITechnologiesPackage.MAIN_WATER_HEATER:
                return createMainWaterHeater();
            case ITechnologiesPackage.WATER_TANK:
                return createWaterTank();
            case ITechnologiesPackage.SOLAR_WATER_HEATER:
                return createSolarWaterHeater();
            case ITechnologiesPackage.IMMERSION_HEATER:
                return createImmersionHeater();
            case ITechnologiesPackage.COOKER:
                return createCooker();
            case ITechnologiesPackage.STORAGE_HEATER:
                return createStorageHeater();
            case ITechnologiesPackage.COMMUNITY_HEAT_SOURCE:
                return createCommunityHeatSource();
            case ITechnologiesPackage.COMMUNITY_CHP:
                return createCommunityCHP();
            case ITechnologiesPackage.ROOM_HEATER:
                return createRoomHeater();
            case ITechnologiesPackage.HEAT_PUMP:
                return createHeatPump();
            case ITechnologiesPackage.WARM_AIR_SYSTEM:
                return createWarmAirSystem();
            case ITechnologiesPackage.POINT_OF_USE_WATER_HEATER:
                return createPointOfUseWaterHeater();
            case ITechnologiesPackage.HEAT_PUMP_WARM_AIR_SYSTEM:
                return createHeatPumpWarmAirSystem();
            case ITechnologiesPackage.WARM_AIR_CIRCULATOR:
                return createWarmAirCirculator();
            case ITechnologiesPackage.BACK_BOILER:
                return createBackBoiler();
            case ITechnologiesPackage.OPERATIONAL_COST:
                return createOperationalCost();
            case ITechnologiesPackage.SOLAR_PHOTOVOLTAIC:
                return createSolarPhotovoltaic();
            case ITechnologiesPackage.ADJUSTER:
                return createAdjuster();
            case ITechnologiesPackage.HYBRID_HEATER:
                return createHybridHeater();
            case ITechnologiesPackage.MIXER_SHOWER:
                return createMixerShower();
            case ITechnologiesPackage.ELECTRIC_SHOWER:
                return createElectricShower();
            case ITechnologiesPackage.ENERGY_USE_ADJUSTER:
                return createEnergyUseAdjuster();
            default:
