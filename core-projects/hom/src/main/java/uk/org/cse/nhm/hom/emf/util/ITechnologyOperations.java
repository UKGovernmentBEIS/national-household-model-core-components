...
public interface ITechnologyOperations {
	/**
	 * This will find anything which implements IHasInstallationYear in the technology model whose
	 * installation year is unset, and set it to the given year.
	 * 
	 * As a result, if you install some new things in a house you can call this and they will end up
	 * with the right installation year.
	 * 
	 * @param technologies
	 * @return 
	 */
	...
	/**
	 * Install a new heat source into the technology model, and connect it up to the space & water heating
	 * systems as suggested. Will also remove any defunct heat source or heating system in the process.
	 * 
	 * @param technologies
	 * @param newHeatSource
	 * @param forSpace
	...
	/**
	 * @return The fuel type of the primary heating system if one is present and working, otherwise the fuel type of the secondary heating system..
	 */
