...
/**
 * POJO containing the basic attributes of a case, which can't really be changed by a measure, and are not derived
 * properties of any of the rest of the case's condition. These are things like AACode, built form, region and so on.
 * 
 * @author hinton
 *
 */
