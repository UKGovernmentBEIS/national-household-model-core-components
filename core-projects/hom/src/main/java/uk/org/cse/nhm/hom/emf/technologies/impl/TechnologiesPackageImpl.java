...
public class TechnologiesPackageImpl extends EPackageImpl implements ITechnologiesPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link ITechnologiesPackage#eINSTANCE}
    ...
    public static ITechnologiesPackage init() {
        if (isInited) {
            return (ITechnologiesPackage) EPackage.Registry.INSTANCE.getEPackage(ITechnologiesPackage.eNS_URI);
        }
