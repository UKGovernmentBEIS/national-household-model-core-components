 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.EnergyUseAdjusterImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.EnergyUseAdjusterImpl#getConstantTerm
 * <em>Constant Term</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.EnergyUseAdjusterImpl#getLinearTerm
 * <em>Linear Term</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.EnergyUseAdjusterImpl#getAdjustmentType
...
public class EnergyUseAdjusterImpl extends MinimalEObjectImpl implements IEnergyUseAdjuster {
    ...
    /**
     * The default value of the '{@link #getConstantTerm() <em>Constant
     * Term</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getConstantTerm() <em>Constant
     * Term</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #getLinearTerm() <em>Linear Term</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getLinearTerm() <em>Linear Term</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #getAdjustmentType() <em>Adjustment
     * Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getAdjustmentType()
    ...
    /**
     * The flags representing the default value of the '{@link #getAdjustmentType()
     * <em>Adjustment Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #getAdjustmentType()
     * <em>Adjustment Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    public void setAdjustmentType(AdjusterType newAdjustmentType) {
        ...
        if (newAdjustmentType == null) {
            newAdjustmentType = ADJUSTMENT_TYPE_EDEFAULT;
        }
    ...
    public void accept(final IConstants constants, final IEnergyCalculatorParameters parameters, final IEnergyCalculatorVisitor visitor, final AtomicInteger heatingSystemCounter, final IHeatProportions heatProportions) {
        ...
        switch (this.getAdjustmentType()) {
            case COOKER:
                if (parameters.getCalculatorType().cookers != ECCookers.PRODUCTS_POLICY) {
                    return;
                }
                serviceType = ServiceType.COOKING;
                break;
            default:
                if (parameters.getCalculatorType().appliances != ECAppliances.PRODUCTS_POLICY) {
                    return;
                }
