...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Central Heating
 * System</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CentralHeatingSystemImpl#getHeatSource
...
public class CentralHeatingSystemImpl extends SpaceHeaterImpl implements ICentralHeatingSystem, IHeatingSystem {
    ...
    /**
     * The cached value of the '{@link #getHeatSource() <em>Heat Source</em>}'
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #getEmitterType() <em>Emitter
     * Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getEmitterType()
    ...
    /**
     * The flags representing the default value of the '{@link #getEmitterType()
     * <em>Emitter Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flags representing the value of the '{@link #getEmitterType()
     * <em>Emitter Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    public void setEmitterType(EmitterType newEmitterType) {
        ...
        if (newEmitterType == null) {
            newEmitterType = EMITTER_TYPE_EDEFAULT;
        }
    ...
    /**
     * This is determined in SAP table 4e, depending on heat source type and
     * controls. Consequently we could do the lookup here - however, to allow
     * for new kinds of heat source to be introduced without affecting this
     * logic we will instead delegate to the heat source. Standard heat sources
     * can then do the normal lookup.
     */
    @Override
