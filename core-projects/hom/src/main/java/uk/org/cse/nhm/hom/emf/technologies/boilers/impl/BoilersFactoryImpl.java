...
public class BoilersFactoryImpl extends EFactoryImpl implements IBoilersFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case IBoilersPackage.BOILER: return createBoiler();
			case IBoilersPackage.CPSU: return createCPSU();
			case IBoilersPackage.KEEP_HOT_FACILITY: return createKeepHotFacility();
			case IBoilersPackage.STORAGE_COMBI_BOILER: return createStorageCombiBoiler();
			case IBoilersPackage.INSTANTANEOUS_COMBI_BOILER: return createInstantaneousCombiBoiler();
			default:
