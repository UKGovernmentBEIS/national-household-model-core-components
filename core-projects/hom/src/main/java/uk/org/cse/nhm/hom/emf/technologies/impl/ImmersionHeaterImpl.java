 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.ImmersionHeaterImpl#isDualCoil
 * <em>Dual Coil</em>}</li>
 * </ul>
 *
 * @generated
...
public class ImmersionHeaterImpl extends CentralWaterHeaterImpl implements IImmersionHeater {
    ...
    /**
     * The default value of the '{@link #isDualCoil() <em>Dual Coil</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isDualCoil() <em>Dual
     * Coil</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    private double getHighRateFraction(final IInternalParameters parameters, final double tankVolume) {
        ...
        if (parameters.getTarrifType() == ElectricityTariffType.FLAT_RATE) {
            return 1;
        }
