 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.CPSUImpl#getStore
 * <em>Store</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.CPSUImpl#getStoreTemperature
 * <em>Store Temperature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CPSUImpl extends BoilerImpl implements ICPSU {
    ...
    /**
     * The default value of the '{@link #getStoreTemperature() <em>Store
    ...
    /**
     * The cached value of the '{@link #getStoreTemperature() <em>Store
     * Temperature</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
        ...
        if (baseClass == IStoreContainer.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.STORE_CONTAINER__STORE:
                    return IBoilersPackage.CPSU__STORE;
                default:
                    return -1;
            }
        }
    ...
    /**
     * Because in SAP table 4c (efficiency adjustments) CPSU water efficiency is
     * not affected by presence of interlock, we override the method from the
     * basic boiler here.
     */
    @Override
    ...
    /**
     * Electric CPSU and storage boilers have a fixed responsiveness, for no
     * reason.
     */
    @Override
