 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.WaterTankImpl#getInsulation
 * <em>Insulation</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.WaterTankImpl#isFactoryInsulation
 * <em>Factory Insulation</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.WaterTankImpl#getVolume
 * <em>Volume</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.WaterTankImpl#isThermostatFitted
 * <em>Thermostat Fitted</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.WaterTankImpl#getSolarStorageVolume
 * <em>Solar Storage Volume</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.WaterTankImpl#getImmersionHeater
...
public class WaterTankImpl extends MinimalEObjectImpl implements IWaterTank {
    ...
    /**
     * The default value of the '{@link #getInsulation() <em>Insulation</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getInsulation() <em>Insulation</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isFactoryInsulation() <em>Factory
     * Insulation</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isFactoryInsulation()
    ...
    /**
     * The default value of the '{@link #getVolume() <em>Volume</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isThermostatFitted() <em>Thermostat
     * Fitted</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isThermostatFitted()
    ...
    /**
     * The default value of the '{@link #getSolarStorageVolume() <em>Solar
     * Storage Volume</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getSolarStorageVolume() <em>Solar
     * Storage Volume</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getImmersionHeater() <em>Immersion
     * Heater</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * <!-- begin-user-doc -->
     * BEISDOC NAME: Cylinder factory insulated DESCRIPTION: Whether or not the
     * cylinder is factory insulated TYPE: value UNIT: Boolean SAP: Input
     * SAP_COMPLIANT: N/A - value from stock BREDEM: Input BREDEM_COMPLIANT: N/A
     * - value from stock STOCK: water-heating.csv (cylinderfactoryinsulated)
     * ID: cylinder-insulation-type CODSIEB
     * <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public void setFactoryInsulation(boolean newFactoryInsulation) {
        ...
        if (newFactoryInsulation) {
            flags |= FACTORY_INSULATION_EFLAG;
        } else {
            flags &= ~FACTORY_INSULATION_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    /**
     * <!-- begin-user-doc -->
     * BEISDOC NAME: Cylinder volume DESCRIPTION: The volume of the hot water
     * cylinder (or the internal store of a storage combi or CPSU). TYPE: value
     * UNIT: m^3 SAP: (47) SAP_COMPLIANT: N/A - value from stock BREDEM: User
     * input BREDEM_COMPLIANT: N/A - value from stock SET: cylinder-volume
     * property when installing a measure STOCK: water-heating.csv
     * (cylindervolume) ID: cylinder-volume CODSIEB
     * <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public void setThermostatFitted(boolean newThermostatFitted) {
        ...
        if (newThermostatFitted) {
            flags |= THERMOSTAT_FITTED_EFLAG;
        } else {
            flags &= ~THERMOSTAT_FITTED_EFLAG;
        }
        if (eNotificationRequired()) {
     ...
     *
     * This does not take account of SAP Table 2b, the temperature factor,
     * because the tank does not have enough information to determine the value
     * correctly.
     *
     * Instead, it is the responsibility of the central water heating system and
     * the boiler together.
     *
