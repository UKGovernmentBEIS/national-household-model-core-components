...
public class BoilersPackageImpl extends EPackageImpl implements IBoilersPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link IBoilersPackage#eINSTANCE} when
    ...
    public static IBoilersPackage init() {
        if (isInited) {
            return (IBoilersPackage) EPackage.Registry.INSTANCE.getEPackage(IBoilersPackage.eNS_URI);
        }
