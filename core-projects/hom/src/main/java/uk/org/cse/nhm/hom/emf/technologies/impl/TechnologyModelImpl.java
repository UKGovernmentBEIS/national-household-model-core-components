 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getAppliances
 * <em>Appliances</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getLights
 * <em>Lights</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getIndividualHeatSource
 * <em>Individual Heat Source</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getCookers
 * <em>Cookers</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getPrimarySpaceHeater
 * <em>Primary Space Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getSecondarySpaceHeater
 * <em>Secondary Space Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getCentralWaterSystem
 * <em>Central Water System</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getSecondaryWaterHeater
 * <em>Secondary Water Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getCommunityHeatSource
 * <em>Community Heat Source</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getSolarPhotovoltaic
 * <em>Solar Photovoltaic</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getAdjusters
 * <em>Adjusters</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getShower
 * <em>Shower</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.TechnologyModelImpl#getEnergyUseAdjusters
...
public class TechnologyModelImpl extends MinimalEObjectImpl implements ITechnologyModel, ICopyable<ITechnologyModel> {
    ...
    /**
     * <!-- begin-user-doc -->
     * This corresponds to heating system 693 "Portable Electric Heaters" and
     * 699 "Electric heaters (assumed)" in SAP tables 4a to 4c. It is used when
     * the primary space heater is missing or broken. It is also used when the
     * secondary heating is required but missing (see SAP Table 11 below).
     *
     * We've represented portable electric heaters as an electric room heater,
     * since this should provide identical results.
     * <!-- end-user-doc -->
     *
     * @generated NO
     */
    ...
    /**
     * <!-- begin-user-doc -->
     * If there are no water heaters present, hot water is assumed to be
    ...
    /**
     * The cached value of the '{@link #getAppliances() <em>Appliances</em>}'
    ...
    /**
     * The cached value of the '{@link #getLights() <em>Lights</em>}'
     * containment reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getIndividualHeatSource() <em>Individual
     * Heat Source</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getCookers() <em>Cookers</em>}'
     * containment reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getPrimarySpaceHeater() <em>Primary
     * Space Heater</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getSecondarySpaceHeater() <em>Secondary
     * Space Heater</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getCentralWaterSystem() <em>Central
     * Water System</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getCommunityHeatSource() <em>Community
     * Heat Source</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getSolarPhotovoltaic() <em>Solar
     * Photovoltaic</em>}' containment reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getAdjusters() <em>Adjusters</em>}'
     * containment reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getShower() <em>Shower</em>}'
    ...
    /**
     * The cached value of the '{@link #getEnergyUseAdjusters() <em>Energy Use
     * Adjusters</em>}' containment reference list.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * An adapter which listens to a technology model, and erases its total
     * operational cost cache when the contents of the model are changed. It
     * also unhooks itself when the cache is erased, and is rehooked when the
     * cache is updated in {#getTotalOperationalCost()}
     */
    ...
    /**
     * <!-- begin-user-doc -->
     * Returns the heat proportion generated by the secondary heater based on
     * the primary heater type, using SAP Table 11.
     *
     * We have assumed that the storage heater "not fan-assisted" row refers to
     * slimline and large volume heaters.
     *
     * We don't have sufficient data to implement appendix N for heat pumps and
     * micro co-generation, so we use the "Heat pump, data from Table 4a" entry
     * for those.
     * <!-- end-user-doc -->
     *
     * @generated NO
     ...
     *
     * Storage heaters (unless integrated) and off-peak underfloor electric
     * always requires a secondary heater.
     *
     * <!-- end-user-doc -->
     *
     * @generated NO
    ...
    /**
     * <!-- begin-user-doc -->
     * This overridden version of the accept method looks at all the contents of
     * this technology model, and if any of them are also instances of
     * {@link IVisitorAccepter} calls their accept method.
     * <!-- end-user-doc -->
     *
     * @generated NO
     */
