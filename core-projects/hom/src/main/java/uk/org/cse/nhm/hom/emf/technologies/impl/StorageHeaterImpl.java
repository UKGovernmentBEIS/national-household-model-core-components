 ...
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.StorageHeaterImpl#getResponsiveness
 * <em>Responsiveness</em>}</li>
 * </ul>
 * </p>
 *
...
public class StorageHeaterImpl extends SpaceHeaterImpl implements IStorageHeater, IHeatingSystem {
    ...
    /**
     * The default value of the '{@link #getResponsivenessOverride()
    ...
    /**
     * The cached value of the '{@link #getResponsivenessOverride()
     * <em>Responsiveness Override</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #getControlType() <em>Control
     * Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getControlType()
    ...
    /**
     * The flags representing the default value of the '{@link #getControlType()
     * <em>Control Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * '{@link StorageHeaterControlType Storage Heater Control Type}'
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
    ...
    /**
     * The flags representing the value of the '{@link #getControlType()
     * <em>Control Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getType()
    ...
    /**
     * The flags representing the default value of the '{@link #getType()
     * <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The array of enumeration values for
     * '{@link StorageHeaterType Storage Heater Type}'
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
    ...
    /**
     * The flags representing the value of the '{@link #getType()
     * <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isHasResponsivenessOverride() <em>Has
     * Responsiveness Override</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isHasResponsivenessOverride()
    ...
    public void setControlType(StorageHeaterControlType newControlType) {
        ...
        if (newControlType == null) {
            newControlType = CONTROL_TYPE_EDEFAULT;
        }
    ...
    public void setHasResponsivenessOverride(boolean newHasResponsivenessOverride) {
        ...
        if (newHasResponsivenessOverride) {
            flags |= HAS_RESPONSIVENESS_OVERRIDE_EFLAG;
        } else {
            flags &= ~HAS_RESPONSIVENESS_OVERRIDE_EFLAG;
        }
        if (eNotificationRequired()) {
        ...
        if (baseClass == IOperationalCost.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.OPERATIONAL_COST__ANNUAL_OPERATIONAL_COST:
                    return ITechnologiesPackage.STORAGE_HEATER__ANNUAL_OPERATIONAL_COST;
                default:
                    return -1;
            }
        }
    ...
    /**
     * This is defined by Table 4e, which states that manual charge control
     * implies +0.3 degrees temperature adjustment.
     */
    @Override
