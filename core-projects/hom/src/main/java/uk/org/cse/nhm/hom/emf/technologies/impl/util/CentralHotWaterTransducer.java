...
/**
 * This is a helper class for the {@link CentralWaterSystemImpl}, which contains
 * the meat of the hot water usage calculation defined in BREDEM 8 2009.
 *
 * It combines together all the {@link ICentralWaterHeater} implementations in
 * the system to produce a single {@link IEnergyTransducer} that will supply
 * some quantity of hot water.
 *
 * In earlier versions this was an inner class in
 * {@link CentralWaterHeatingComponent}.
 *
 * @author hinton
 *
 */
public class CentralHotWaterTransducer extends EnergyTransducer {
     ...
     * apportioned to them pro rata their generated hot water (i.e. if there is
     * a system which produces 10% of hot water, it satisfies 10% of demand, and
     * pays for 10% of tank losses). BREDEM does not specify this.
     */
    @Override
    public void generate(final IEnergyCalculatorHouseCase house,
        ...
        /**
         * Whether any of the water heaters in the system are solar water
         * heaters.
         */
        ...
        /**
         * The proportion of hot water demand that is emitted as distribution
         * losses
         */
        ...
        /**
         * The amount of the total demand generated that was generated by
         * non-solar systems
         */
         ...
         */
        /**
         * The amount of distribution losses that were incurred whilst
         * satisfying demand
         */
 ...
 /*
    ...
    /**
     * Get standard primary pipework losses for different kinds of
     * {@link IHeatSource} and {@link IWarmAirSystem} used for DHW.
     *
     * @param parameters
    ...
    protected final double getPrimaryPipeworkLosses(
		...
		CODSIEB
         */
        return ppCoefficent * ((((pipeworkInsulatedFraction * insulatedMultiplier)
                + ((1 - pipeworkInsulatedFraction) * uninsulatedMultiplier))
                * hoursPerDayHot)
                + ppConstant) * solarCorrectionFactor;
    }
