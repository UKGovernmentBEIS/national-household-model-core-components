 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.RoomHeaterImpl#getFuel
 * <em>Fuel</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.RoomHeaterImpl#getFlueType
 * <em>Flue Type</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.RoomHeaterImpl#getEfficiency
 * <em>Efficiency</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.RoomHeaterImpl#isThermostatFitted
...
public class RoomHeaterImpl extends SpaceHeaterImpl implements IRoomHeater {
    ...
    /**
     * The default value of the '{@link #getFlueType() <em>Flue Type</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getFlueType()
     * <em>Flue Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
    ...
    /**
     * The flags representing the default value of the '{@link #getFlueType()
     * <em>Flue Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flags representing the value of the '{@link #getFlueType() <em>Flue
     * Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    public void setFlueType(FlueType newFlueType) {
        ...
        if (newFlueType == null) {
            newFlueType = FLUE_TYPE_EDEFAULT;
        }
    ...
    /**
     * <!-- begin-user-doc -->
     * Accept the given visitor - this should present the room heater as a
     * heating system.
     * <!-- end-user-doc -->
     *
     * @generated not
    ...
    /**
     * Factored out into a static method to allow use from multiply inheriting
     * {@link BackBoilerImpl}.
     *
     * @param self
     * @param parameters
    ...
    protected static void accept(final IRoomHeater self, final IConstants constants, final IEnergyCalculatorParameters parameters, final IEnergyCalculatorVisitor visitor, final AtomicInteger heatingSystemCounter, IHeatProportions heatProportions, final boolean isBackBoiler) {
        ...
        if (self.getFuel() == FuelType.ELECTRICITY) {
            ...
            StepRecorder.recordStep(
                    /**
                     * These are probably assumed direct electric heaters (see
                     * TechnologyModelImpl), although they could just be an
                     * electric room heater (unlikely) This means we need to
                     * work out whether they're primary or secondary. The
                     * proportion is a reliable way to do this.
                     *
                     * SAP says that if a heater is heating at least 30% of the
                     * house, it's a candidate to be a main space heating
                     * system.
                     */
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == IFuelAndFlue.class) {
            switch (derivedFeatureID) {
                case ITechnologiesPackage.ROOM_HEATER__FUEL:
                    return ITechnologiesPackage.FUEL_AND_FLUE__FUEL;
                case ITechnologiesPackage.ROOM_HEATER__FLUE_TYPE:
                    return ITechnologiesPackage.FUEL_AND_FLUE__FLUE_TYPE;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == IFuelAndFlue.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.FUEL_AND_FLUE__FUEL:
                    return ITechnologiesPackage.ROOM_HEATER__FUEL;
                case ITechnologiesPackage.FUEL_AND_FLUE__FLUE_TYPE:
                    return ITechnologiesPackage.ROOM_HEATER__FLUE_TYPE;
                default:
                    return -1;
            }
        }
