 ...
 *
 * <!-- begin-model-doc -->
 * A central water heater is something which can provide heat into a central water system. For example, this would be an immersion heater in the hot water tank,a solar system, or a connection to a heat source like a boiler.
 * <!-- end-model-doc -->
 *
 *
 * @see uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getCentralWaterHeater()
 * @model abstract="true"
 * @generated
 */
public interface ICentralWaterHeater extends EObject {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return (ICentralWaterSystem) eContainer();'"
	 * @generated
	 */
