...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Storage Heater
 * Control Type</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 *
 * @see
 * uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getStorageHeaterControlType()
 * @model
 * @generated
 */
public enum StorageHeaterControlType implements Enumerator {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Manual Charge Control</b></em>' literal object
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Automatic Charge Control</b></em>' literal
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Celect Charge Control</b></em>' literal object
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     *
    ...
    /**
     * An array of all the '<em><b>Storage Heater Control Type</b></em>'
     * enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * A public read-only list of all the '<em><b>Storage Heater Control
    ...
    /**
     * Returns the '<em><b>Storage Heater Control Type</b></em>' literal with
    ...
    public static StorageHeaterControlType get(int value) {
        switch (value) {
            case MANUAL_CHARGE_CONTROL_VALUE:
                return MANUAL_CHARGE_CONTROL;
            case AUTOMATIC_CHARGE_CONTROL_VALUE:
                return AUTOMATIC_CHARGE_CONTROL;
            case CELECT_CHARGE_CONTROL_VALUE:
                return CELECT_CHARGE_CONTROL;
        }
        return null;
    }
