 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.StorageCombiBoilerImpl#getStore
 * <em>Store</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.StorageCombiBoilerImpl#isStoreInPrimaryCircuit
        ...
        if (baseClass == IStoreContainer.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.STORE_CONTAINER__STORE:
                    return IBoilersPackage.STORAGE_COMBI_BOILER__STORE;
                default:
                    return -1;
            }
        }
