 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatSourceImpl#getFuel
 * <em>Fuel</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatSourceImpl#getFlueType
 * <em>Flue Type</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatSourceImpl#getAnnualOperationalCost
 * <em>Annual Operational Cost</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatSourceImpl#getInstallationYear
 * <em>Installation Year</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatSourceImpl#getWaterHeater
 * <em>Water Heater</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatSourceImpl#getSpaceHeater
...
public abstract class HeatSourceImpl extends MinimalEObjectImpl implements IHeatSource {
    ...
    /**
     * The default value of the '{@link #getInstallationYear() <em>Installation
     * Year</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getInstallationYear() <em>Installation
     * Year</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing whether the Installation Year attribute has been
     * set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getWaterHeater() <em>Water Heater</em>}'
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getSpaceHeater() <em>Space Heater</em>}'
     * reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * <!-- begin-user-doc -->
     * The default behaviour for storage temperature factor, which is impemented
     * in {@link HotWaterUtilities}.
     * <!-- end-user-doc -->
     *
     * @generated no
     */
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == IHasInstallationYear.class) {
            switch (derivedFeatureID) {
                case ITechnologiesPackage.HEAT_SOURCE__INSTALLATION_YEAR:
                    return ITechnologiesPackage.HAS_INSTALLATION_YEAR__INSTALLATION_YEAR;
                default:
                    return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == IOperationalCost.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.OPERATIONAL_COST__ANNUAL_OPERATIONAL_COST:
                    return ITechnologiesPackage.HEAT_SOURCE__ANNUAL_OPERATIONAL_COST;
                default:
                    return -1;
            }
        }
        if (baseClass == IHasInstallationYear.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.HAS_INSTALLATION_YEAR__INSTALLATION_YEAR:
                    return ITechnologiesPackage.HEAT_SOURCE__INSTALLATION_YEAR;
                default:
                    return -1;
            }
        }
    ...
    public String toString() {
        ...
        if ((flags & INSTALLATION_YEAR_ESETFLAG) != 0) {
            result.append(installationYear);
        } else {
            result.append("<unset>");
        }
