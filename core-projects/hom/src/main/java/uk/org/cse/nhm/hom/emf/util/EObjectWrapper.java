...
/**
 * This is a wrapper for arbitrary EObjects which makes equals & hashcode semantics work like java, rather
 * than as UML dictates.
 * 
 * <p>
 * Java expects that {@link Object#equals(Object)} tests equality rather than identity, whereas ECore follows
 * the UML expectation that identity is tested for objects, and deep equality is only used for datatypes.
 * <p>
 * Instantiating this with an EObject inside it will let you use the EObject as a key in a map, for example,
 * or place EObjects in sets correctly
 * <p>
 * If you modify the wrapped object, the hashcode for the wrapper may be invalidated.
 * @author hinton
 *
 */
