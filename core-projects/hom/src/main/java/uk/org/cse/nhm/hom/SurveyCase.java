...
/**
 * This is the representation of a survey case, suitable for serialization into
 * mongo.
 *
 * It contains representations for the various different dimensions into which a
 * house is sliced for the simulation's purposes.
 *
 * All of the actual data are stored in objects within this; it's just a big
 * container.
 *
 * @author hinton
 *
