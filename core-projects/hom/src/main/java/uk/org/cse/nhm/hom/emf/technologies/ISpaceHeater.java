 ...
 *
 * <!-- begin-model-doc -->
 * A space heater is anything which can meet some of the heat demand in the house, so either a central heating system or a direct heater like a fireplace or electric heater.
 * <!-- end-model-doc -->
 *
 *
 * @see uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getSpaceHeater()
 * @model abstract="true"
 * @generated
 */
