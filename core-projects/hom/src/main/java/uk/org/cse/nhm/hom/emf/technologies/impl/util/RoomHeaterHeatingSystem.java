 ...
 *
 * This is to avoid code duplication between {@link IBackBoiler} and
 * {@link IRoomHeater}.
 *
 * @author hinton
 *
...
public class RoomHeaterHeatingSystem implements IHeatingSystem {
    ...
    /**
     * SAP Table 4e Group 6 explains room heater systems, and details that there
     * is a +0.3 deg demand temperature adjustment if the heater does not have a
     * thermostat fitted.
     */
    @Override
    ...
    /**
     * SAP Table 4e Group 6 says that room heaters have a control type of 2 if
     * they are not thermostatic, or 3 otherwise.
     */
    @Override
