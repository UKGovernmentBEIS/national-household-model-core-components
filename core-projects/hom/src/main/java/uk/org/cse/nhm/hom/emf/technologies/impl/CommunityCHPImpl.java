...
/**
 * <!-- begin-user-doc -->
 * The difference between this and community heat source is just that it
 * generates a bit of electricity for carbon offsetting purposes. As such, all
 * it does on top of the base class is (a) generate some electricity through the
 * {@link #consumeSystemFuel(IEnergyState, double)} method, and (b) modify the
 * transducer outputs to include non-leading community electricity.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.CommunityCHPImpl#getElectricalEfficiency
 * <em>Electrical Efficiency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommunityCHPImpl extends CommunityHeatSourceImpl implements ICommunityCHP {
    ...
    /**
     * The default value of the '{@link #getElectricalEfficiency()
     * <em>Electrical Efficiency</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getElectricalEfficiency() <em>Electrical
    ...
    protected void consumeSystemFuel(final IConstants constants, final IEnergyState state, final double communityHeatRequired) {
        ...
        final double fuelForSpace
                = (communityHeatRequired //				 * constants.get(CommunityHeatingConstants.DEFAULT_DISTRIBUTION_LOSS_FACTOR)
                )
