...
public class BoilersSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case IBoilersPackage.BOILER: {
                ...
                if (result == null) {
                    result = caseIndividualHeatSource(boiler);
                }
                if (result == null) {
                    result = caseVisitorAccepter(boiler);
                }
                if (result == null) {
                    result = caseHeatSource(boiler);
                }
                if (result == null) {
                    result = caseFuelAndFlue(boiler);
                }
                if (result == null) {
                    result = caseOperationalCost(boiler);
                }
                if (result == null) {
                    result = caseHasInstallationYear(boiler);
                }
                if (result == null) {
            ...
            case IBoilersPackage.CPSU: {
                ...
                if (result == null) {
                    result = caseBoiler(cpsu);
                }
                if (result == null) {
                    result = caseStoreContainer(cpsu);
                }
                if (result == null) {
                    result = caseIndividualHeatSource(cpsu);
                }
                if (result == null) {
                    result = caseVisitorAccepter(cpsu);
                }
                if (result == null) {
                    result = caseHeatSource(cpsu);
                }
                if (result == null) {
                    result = caseFuelAndFlue(cpsu);
                }
                if (result == null) {
                    result = caseOperationalCost(cpsu);
                }
                if (result == null) {
                    result = caseHasInstallationYear(cpsu);
                }
                if (result == null) {
                    result = defaultCase(theEObject);
                }
            ...
            case IBoilersPackage.STORAGE_COMBI_BOILER: {
                ...
                if (result == null) {
                    result = caseCombiBoiler(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseStoreContainer(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseBoiler(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseIndividualHeatSource(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseVisitorAccepter(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseHeatSource(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseFuelAndFlue(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseOperationalCost(storageCombiBoiler);
                }
                if (result == null) {
                    result = caseHasInstallationYear(storageCombiBoiler);
                }
                if (result == null) {
                    result = defaultCase(theEObject);
                }
            ...
            case IBoilersPackage.INSTANTANEOUS_COMBI_BOILER: {
                ...
                if (result == null) {
                    result = caseCombiBoiler(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseBoiler(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseIndividualHeatSource(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseVisitorAccepter(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseHeatSource(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseFuelAndFlue(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseOperationalCost(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = caseHasInstallationYear(instantaneousCombiBoiler);
                }
                if (result == null) {
                    result = defaultCase(theEObject);
                }
            ...
            case IBoilersPackage.COMBI_BOILER: {
                ...
                if (result == null) {
                    result = caseBoiler(combiBoiler);
                }
                if (result == null) {
                    result = caseIndividualHeatSource(combiBoiler);
                }
                if (result == null) {
                    result = caseVisitorAccepter(combiBoiler);
                }
                if (result == null) {
                    result = caseHeatSource(combiBoiler);
                }
                if (result == null) {
                    result = caseFuelAndFlue(combiBoiler);
                }
                if (result == null) {
                    result = caseOperationalCost(combiBoiler);
                }
                if (result == null) {
                    result = caseHasInstallationYear(combiBoiler);
                }
                if (result == null) {
                    result = defaultCase(theEObject);
                }
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Keep
     * Hot Facility</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null; returning a non-null result will
     * terminate the switch.
     ...
     *
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Keep
     * Hot Facility</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Heat
     * Source</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null; returning a non-null result will
     * terminate the switch.
     ...
     *
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Heat
     * Source</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Fuel
     * And Flue</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null; returning a non-null result will
     * terminate the switch.
     ...
     *
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Fuel
     * And Flue</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
