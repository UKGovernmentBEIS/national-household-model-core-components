 ...
 * <!-- begin-user-doc -->
 *
 * This is a room heater which is also a back boiler - It employs EMF multiple
 * inheritance, which means that some code from {@link RoomHeaterImpl} has been
 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.BackBoilerImpl#getEfficiency
 * <em>Efficiency</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.BackBoilerImpl#isThermostatFitted
...
public class BackBoilerImpl extends BoilerImpl implements IBackBoiler {
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == IRoomHeater.class) {
            switch (derivedFeatureID) {
                case ITechnologiesPackage.BACK_BOILER__EFFICIENCY:
                    return ITechnologiesPackage.ROOM_HEATER__EFFICIENCY;
                case ITechnologiesPackage.BACK_BOILER__THERMOSTAT_FITTED:
                    return ITechnologiesPackage.ROOM_HEATER__THERMOSTAT_FITTED;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == IRoomHeater.class) {
            switch (baseFeatureID) {
                case ITechnologiesPackage.ROOM_HEATER__EFFICIENCY:
                    return ITechnologiesPackage.BACK_BOILER__EFFICIENCY;
                case ITechnologiesPackage.ROOM_HEATER__THERMOSTAT_FITTED:
                    return ITechnologiesPackage.BACK_BOILER__THERMOSTAT_FITTED;
                default:
                    return -1;
            }
        }
    ...
    /**
     * <!-- begin-user-doc -->
     * Do boiler's accept and
     * {@link RoomHeaterImpl#accept(IRoomHeater, IEnergyCalculatorParameters, IEnergyCalculatorVisitor, AtomicInteger, double, double)}
     * <!-- end-user-doc -->
     *
     * @generated not
     */
