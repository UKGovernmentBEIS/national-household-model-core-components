 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.BoilerImpl#getSummerEfficiency
 * <em>Summer Efficiency</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.BoilerImpl#getWinterEfficiency
 * <em>Winter Efficiency</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.BoilerImpl#isCondensing
 * <em>Condensing</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.BoilerImpl#isWeatherCompensated
 * <em>Weather Compensated</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.BoilerImpl#isPumpInHeatedSpace
 * <em>Pump In Heated Space</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.boilers.impl.BoilerImpl#getEfficiencySource
 * <em>Efficiency Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoilerImpl extends HeatSourceImpl implements IBoiler {
    ...
    /**
     * The default value of the '{@link #getSummerEfficiency() <em>Summer
    ...
    /**
     * The cached value of the '{@link #getSummerEfficiency() <em>Summer
     * Efficiency</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #getWinterEfficiency() <em>Winter
     * Efficiency</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getWinterEfficiency() <em>Winter
     * Efficiency</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isCondensing() <em>Condensing</em>}'
     * attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isCondensing()
     * <em>Condensing</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see #isCondensing()
    ...
    /**
     * The default value of the '{@link #isWeatherCompensated() <em>Weather
     * Compensated</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isWeatherCompensated()
     * <em>Weather Compensated</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see #isWeatherCompensated()
    ...
    /**
     * The default value of the '{@link #isPumpInHeatedSpace() <em>Pump In
     * Heated Space</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isPumpInHeatedSpace()
     * <em>Pump In Heated Space</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @see #isPumpInHeatedSpace()
    ...
    /**
     * The default value of the '{@link #getEfficiencySource() <em>Efficiency
     * Source</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getEfficiencySource()
     * <em>Efficiency Source</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
    ...
    /**
     * The flags representing the default value of the '{@link #getEfficiencySource()
     * <em>Efficiency Source</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The array of enumeration values for
     * '{@link EfficiencySourceType Efficiency Source Type}'
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
    ...
    /**
     * The flag representing the value of the '{@link #getEfficiencySource()
     * <em>Efficiency Source</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    public void setWeatherCompensated(boolean newWeatherCompensated) {
        ...
        if (newWeatherCompensated) {
            flags |= WEATHER_COMPENSATED_EFLAG;
        } else {
            flags &= ~WEATHER_COMPENSATED_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    public void setPumpInHeatedSpace(boolean newPumpInHeatedSpace) {
        ...
        if (newPumpInHeatedSpace) {
            flags |= PUMP_IN_HEATED_SPACE_EFLAG;
        } else {
            flags &= ~PUMP_IN_HEATED_SPACE_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    public void setEfficiencySource(EfficiencySourceType newEfficiencySource) {
        ...
        if (newEfficiencySource == null) {
            newEfficiencySource = EFFICIENCY_SOURCE_EDEFAULT;
        }
    ...
    /**
     * This is the water heating efficiency (the weighted average of winter and
     * summer), with adjustments from SAP 2009 Table 4c applied.
     *
     * This is overridden in CPSUs and combis, because their water efficiency is
     * not affected by the thermostatic control of space heating.
     *
     * @param qWater
     * @param qSpace
     * @return
     ...
     *
     * This applies if either of the following are true: + We have a space
     * heating system, but it is not thermostatically controlled + We have a
     * water heating system with a tank, but the tank does not have a thermostat
     *
    ...
    /**
     * This is the space heating efficiency, with adjustments from SAP 2009
     * table 4c included.
     *
     * @param qWater
     * @param qSpace
    ...
    /**
     * Electric boilers should override this method to determine the <em>high
     * rate fraction</em> for a given space & water heat usage.
     *
     * @param parameters
     * @param losses
     * @param state
    ...
    protected double getHighRateFraction(final IInternalParameters parameters, final ISpecificHeatLosses losses, final IEnergyState state, final double qWater, final double qHeat) {
        if (getFuel() != FuelType.ELECTRICITY) {
            throw new RuntimeException("Non-electric boilers do not have a high-rate fraction!");
        }
        return parameters.getConstants().get(SplitRateConstants.ELECTRIC_BOILER_FRACTIONS, parameters.getTarrifType());
    }

    /**
     * This is a helper class which produces the internal power type that this
     * boiler uses (see {@link BoilerImpl#power})
     *
     * @author hinton
     *
     */
    ...
    /**
     * @return true if the central space heater to which this is attached has
     * underfloor emitters.
     */
    ...
    /**
     * Creates an energy transducer which outputs {@link #power} in the
     * production of {@link ServiceType#WATER_HEATING}.
     *
     * If the fuel for this boiler is electric, a transducer is created with an
     * efficiency of 1 that delegates to the
     ...
     *
     * If the boiler is non-electric, fuel is consumed with the efficency
     * calculated by
    ...
    /**
     * This is analogous to {@link #createWaterTransducer(IInternalParameters)},
     * but for space heating.
     *
     * @param power TODO
     * @param parameters
     * @return
    ...
    /**
     * <!-- begin-user-doc -->
     * The main thing this does is introduce the transducers which generate this
     * boiler's energy type, and compute the high rate fraction and/or seasonal
     * efficiency for primary fuel use
     * <!-- end-user-doc -->
     *
     * @generated NO
     */
    ...
    public void accept(final IConstants constants, final IEnergyCalculatorParameters parameters, final IEnergyCalculatorVisitor visitor, final AtomicInteger counter, final IHeatProportions heatProportions) {
        if (isIntermediatePowerRequired()) {
            ...
            if (getWaterHeater() != null) {
                visitor.visitEnergyTransducer(createWaterTransducer(power));
            }
            if (getSpaceHeater() != null) {
                visitor.visitEnergyTransducer(createHeatTransducer(power));
            }
        }
    ...
    /**
     * @return True iff the {@link #power} energy type is required, for example
     * to compute an efficiency or split-rate charge at the end of the
     * computation.
     */
    ...
    /**
     * SAP 2009 Table 4d explains how emitter type affects responsiveness for
     * most wet heating systems, but not all.
     */
    @Override
    ...
    /**
     * As SAP 2009 explains in Table 4e (group 1), boilers have some demand
     * temperature adjustments associated with the heating system controls. The
     * adjustments defined are:
     *
     * +0.6 if (a) no time or thermostatic controls or (b) programmer but no
     * thermostat -0.15 if there is a delayed start thermostat -0.1 for CPSUs
     * (handled in {@link CPSUImpl}, naturally.
     */
    @Override
...
//		final EnumSet<HeatingSystemControlType> controls2 = EnumSet.copyOf(controls);
    ...
    /**
     * This is for additional hot water usage gains/losses (for example ECom,
     * from combi boilers)
     *
     * @param parameters
     * @return
