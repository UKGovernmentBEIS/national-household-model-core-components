 ...
 *
 * @see
 * uk.org.cse.nhm.hom.emf.technologies.boilers.IBoilersPackage#getEfficiencySourceType()
 * @model
 * @generated
 */
public enum EfficiencySourceType implements Enumerator {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>SAP Default</b></em>' literal object isn't
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Manufacturer Declared</b></em>' literal object
    ...
    /**
     * A public read-only list of all the '<em><b>Efficiency Source
    ...
    /**
     * Returns the '<em><b>Efficiency Source Type</b></em>' literal with the
    ...
    public static EfficiencySourceType get(int value) {
        switch (value) {
            case SAP_DEFAULT_VALUE:
                return SAP_DEFAULT;
            case MANUFACTURER_DECLARED_VALUE:
                return MANUFACTURER_DECLARED;
        }
        return null;
    }
