 ...
 * </p>
 * <ul>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatPumpImpl#getSourceType
 * <em>Source Type</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatPumpImpl#getCoefficientOfPerformance
 * <em>Coefficient Of Performance</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatPumpImpl#isWeatherCompensated
 * <em>Weather Compensated</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatPumpImpl#isAuxiliaryPresent
 * <em>Auxiliary Present</em>}</li>
 * <li>{@link uk.org.cse.nhm.hom.emf.technologies.impl.HeatPumpImpl#getHybrid
 * <em>Hybrid</em>}</li>
 * </ul>
 *
 * @generated
...
public class HeatPumpImpl extends HeatSourceImpl implements IHeatPump {
    ...
    /**
     * The default value of the '{@link #getSourceType() <em>Source Type</em>}'
     * attribute.
    ...
    /**
     * The offset of the flags representing the value of the '{@link #getSourceType()
    ...
    /**
     * The flags representing the default value of the '{@link #getSourceType()
     * <em>Source Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     ...
     * '{@link HeatPumpSourceType Heat Pump Source Type}'
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated
    ...
    /**
     * The flag representing the value of the '{@link #getSourceType()
     * <em>Source Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #getCoefficientOfPerformance()
     * <em>Coefficient Of Performance</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The cached value of the '{@link #getCoefficientOfPerformance()
     * <em>Coefficient Of Performance</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * The default value of the '{@link #isAuxiliaryPresent() <em>Auxiliary
     * Present</em>}' attribute.
     * <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * The flag representing the value of the '{@link #isAuxiliaryPresent()
    ...
    /**
     * The cached value of the '{@link #getHybrid() <em>Hybrid</em>}'
    ...
    public void setSourceType(HeatPumpSourceType newSourceType) {
        ...
        if (newSourceType == null) {
            newSourceType = SOURCE_TYPE_EDEFAULT;
        }
    ...
    public void setAuxiliaryPresent(boolean newAuxiliaryPresent) {
        ...
        if (newAuxiliaryPresent) {
            flags |= AUXILIARY_PRESENT_EFLAG;
        } else {
            flags &= ~AUXILIARY_PRESENT_EFLAG;
        }
        if (eNotificationRequired()) {
    ...
    public void acceptFromHeating(final IConstants constants, final IEnergyCalculatorParameters parameters, final IEnergyCalculatorVisitor visitor, final double proportion, final int priority) {
        ...
        /**
         * TODO: account for hybrid heat pumps when recording efficiency I
         * haven't done these since the splits are defined per-month The
         * effective efficiency should be 1 / ((split / heatPumpEfficiency) +
         * ((1 - split) / hybridEfficiency))
         */
        if (proportion > 0) {
    ...
    /**
     * @assumption SAP specifies a zone two control parameter for "Programmer
     * and at least two room stats", but we lack information about the number of
     * room stats, and merely know that there is at least one or none.
     * Consequently we assume that there is programmer and room thermostat,
     * corresponding to the fourth row in Group 2 of SAP table 4e.
     */
    @Override
