...
public interface IMutableWall extends IWall {
    ...
    /**
     * Splits this wall into two parts, according to the proportion. For
     * example, if you invoke split(0.1), this wall will be reduced to 10% of
     * its length, and the next wall will be the remaining 90%. The newly
     * created wall will be initialized to have the same properties as this wall
     * (u, k, construction type).
     * <br />
     * This method is intended as a convenience for specifying walls which are
     * partially party walls
     *
     * @param proportion
     */
    ...
    /**
     * This sets the thickness of the wall so that with current
     * internal/external insulation it has the given overall thickness.
     *
     * @param newThickness
     */
