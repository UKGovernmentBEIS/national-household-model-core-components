 ...
 *
 * <!-- begin-model-doc -->
 * A WaterHeater is anything which meets the need for hot water in the house,
 * for example a central DHW system, or a point-of-use heater.
 * <!-- end-model-doc -->
 *
 *
 * @see
 * uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getWaterHeater()
 * @model abstract="true"
 * @generated
 */
