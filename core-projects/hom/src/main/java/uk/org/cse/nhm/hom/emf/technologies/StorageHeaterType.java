 ...
 *
 * @see
 * uk.org.cse.nhm.hom.emf.technologies.ITechnologiesPackage#getStorageHeaterType()
 * @model
 * @generated
 */
public enum StorageHeaterType implements Enumerator {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Old Large Volume</b></em>' literal object isn't
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Fan</b></em>' literal object isn't clear, there
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Integrated Direct Acting</b></em>' literal
    ...
    /**
     * A public read-only list of all the '<em><b>Storage Heater Type</b></em>'
     * enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
    ...
    /**
     * Returns the '<em><b>Storage Heater Type</b></em>' literal with the
    ...
    public static StorageHeaterType get(int value) {
        switch (value) {
            case OLD_LARGE_VOLUME_VALUE:
                return OLD_LARGE_VOLUME;
            case SLIMLINE_VALUE:
                return SLIMLINE;
            ...
            case FAN_VALUE:
                return FAN;
            case INTEGRATED_DIRECT_ACTING_VALUE:
                return INTEGRATED_DIRECT_ACTING;
        }
        return null;
    }
