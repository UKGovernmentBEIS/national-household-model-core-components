...
public interface IAdapter {
    ...
    /**
     * @return true if this adapter can convert the object from into some other
     * type
     */
     ...
     * where to.isInstance(that thing) would be true. If this method returns
     * true, adapts(from) should also be true
     */
    public boolean adapts(final Object from, final Class<?> to);

    /**
     * @return true if there is some possible object A where: a)
     * from.isInstance(A) is true, and b) adapts(A, to) is true
     */
    ...
    /**
     * @return a set of all the classes X where adaptsType(X, Y) is true for
     * some Y.
     */
