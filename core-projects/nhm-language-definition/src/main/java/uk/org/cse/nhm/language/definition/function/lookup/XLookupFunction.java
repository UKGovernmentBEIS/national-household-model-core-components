...
public class XLookupFunction extends XNumber implements ISelfValidating  {
    ...
    /**
     * @return a function which returns a nonempty error string if the input lookuprule
     *         is not a sensible value to compare with an output of f.
     */
    ...
    static class CheckEnumFunction extends CheckFunction {
        ...
        @Override
        protected String allowString(String s) {
            if (legalStrings.isEmpty() || legalStrings.contains(s.toLowerCase())) return "";
