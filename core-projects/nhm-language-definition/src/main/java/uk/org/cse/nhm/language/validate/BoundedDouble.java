...
/**
 * Verify that a double lies in a range; this will pass iff the validated value x satisfies:
 * 
 * {@link #lower()} <= x <= {@link #upper()}
 * @author hinton
 *
 */
public @interface BoundedDouble {
	/**
	 * The lower bound; the validated value should be greater than or equal to this value
	 * @return
	 */
