...
/**
 * An annotation used to define a category of elements in the documentation, or
 * to place an element into a category.
 *
 * Elements will end up in the category of their superclass, if they have no
 * category statement on themselves.
 *
 */
...
public @interface Category {
    ...
    public enum CategoryType implements Comparable<CategoryType> {
        ...
        HEALTH("Health impact modelling", "UCL's health impact model"),
        ...
        private CategoryType(final String display, final String description) {
