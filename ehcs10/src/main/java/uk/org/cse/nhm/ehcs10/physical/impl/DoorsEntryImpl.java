...
public class DoorsEntryImpl extends SurveyEntryImpl implements DoorsEntry {
	private Integer FRONT_Replace;
	private Integer FRONT_EaseReplaceAdjust;
	private Integer FRONT_Age;
	private Integer FRONT_Paint;
	...
	private Integer BACK_RepairGlaze;
	private Integer BACK_Number;
	private Integer BACK_Paint;
	private Integer BACK_EaseReplaceAdjust;
	private Integer FRONT_RepairGlaze;
	private Integer BACK_Leave;
	private Integer BACK_Age;
	private Enum10 BACK_Faults;
	private Enum10 FRONT_Faults;
	private Enum1289 TypeOfDoor;
	...
	public Integer getFRONT_EaseReplaceAdjust() {
		return FRONT_EaseReplaceAdjust;	}

	public void setFRONT_EaseReplaceAdjust(final Integer FRONT_EaseReplaceAdjust) {
		this.FRONT_EaseReplaceAdjust = FRONT_EaseReplaceAdjust;	}
	...
	public void setFRONT_Paint(final Integer FRONT_Paint) {
		this.FRONT_Paint = FRONT_Paint;	}
	...
	public Integer getBACK_RepairGlaze() {
		return BACK_RepairGlaze;	}

	public void setBACK_RepairGlaze(final Integer BACK_RepairGlaze) {
		this.BACK_RepairGlaze = BACK_RepairGlaze;	}
	...
	public void setBACK_Paint(final Integer BACK_Paint) {
		this.BACK_Paint = BACK_Paint;	}

	public Integer getBACK_EaseReplaceAdjust() {
		return BACK_EaseReplaceAdjust;	}

	public void setBACK_EaseReplaceAdjust(final Integer BACK_EaseReplaceAdjust) {
		this.BACK_EaseReplaceAdjust = BACK_EaseReplaceAdjust;	}

	public Integer getFRONT_RepairGlaze() {
		return FRONT_RepairGlaze;	}

	public void setFRONT_RepairGlaze(final Integer FRONT_RepairGlaze) {
		this.FRONT_RepairGlaze = FRONT_RepairGlaze;	}
	...
	public void setTypeOfDoor(final Enum1289 TypeOfDoor) {
