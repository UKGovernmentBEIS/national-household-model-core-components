...
/**
 * The status service provides information about the status of different things machines and services
 * within the NHM.
 * 
 * @since 3.7.0
 * 
...
public interface ITrackingService<Key, T> extends Closeable {
	...
	/**
	 * @return the latest set of statuses for every thing the status service is keeping track of.
	 * @since 3.7.0
	 */
	...
	/**
	 * Adds a callback to execute when a new status update
	 * occurs
	 * 
	 * @since 3.7.0
	 * @param callback
