...
/**
 * 
 * A handle to this should be used to acquire scenarios from wherever
 * they are stored.
 * 
 * @since 3.7.0
 */
public interface IScenarioService {
	...
	/**
	 * Given the provided scenario ID, construct a snapshot containing the scenario
	 * and all of its includes bundled up together.
	 * 
	 * @param scenarioID
	 * @return
	 * @throws SAXException
	...
	/**
	 * Uses entity resolver to produce a snapshot of the given XML
	 * with the includes resolved ready for validation.
	 * 
	 * @since 3.7.0
	 * @param scenarioXML
	 * @return
	...
	/**
	 * Get (possibly creating and storing) a unique identifier which can be used with the name for a given scenario ID;
	 * 
