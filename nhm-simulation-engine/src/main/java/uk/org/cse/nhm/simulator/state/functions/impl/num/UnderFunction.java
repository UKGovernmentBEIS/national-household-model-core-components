...
/**
 * A function which is evaluated under some hypothetical conditions:
 * 	1. If a snapshot name was passed in, we lookup that snapshot and use it. Otherwise we start out hypothesis from the current state.
 *  2. Apply all the hypothesis actions which were passed in.
 *  3. Evaluate the delegate function.
 *  4. Throw away all the changes we made. 
 */
