 ...
 * cost from the {@link IEmissions} dimension and charges you that much paying it to
 * {@link ITransaction.Counterparties#ENERGY_COMPANIES}.
 * 
 * @since 3.7.0
 * 
 */
public class AnnualFuelObligation extends AnnualObligation {
	...
	/**
	 * This is overriding the method in {@link BaseObligation} to short-cut the control flow, which would
	 * otherwise invoke {@link AnnualObligation#generatePayments(org.joda.time.DateTime, IComponentsScope)},
	 * which would in turn invoke {@link #doGeneratePayments(IComponentsScope, ILets)} above, which would
