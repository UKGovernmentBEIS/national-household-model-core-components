...
/**
 * Represents a tariff; this is a device which will work out the price for multiple fuels for you.
 */
public interface ITariff extends IIdentified {
	...
	/**
	 * Compute the cost of the given fuel, and write payments into the given scope.
	 * @param fuelType
	 * @param output
	 */
