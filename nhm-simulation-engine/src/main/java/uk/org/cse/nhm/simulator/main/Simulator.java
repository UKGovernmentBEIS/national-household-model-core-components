...
/**
 * An injector-based simulator; contains a module which configures stuff to the standard
 * interfaces.
 *
 * @author tomh
...
public class Simulator implements ISimulator {
    ...
    public int step() throws NHMException {
    	if (simulationStart == -1) simulationStart = System.currentTimeMillis();
    ...
    /**
     * @return
     * @see uk.org.cse.nhm.simulator.main.ISimulator#getCurrentDate()
     */
    @Override
