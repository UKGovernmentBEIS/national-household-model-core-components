...
/**
 * A dwelling's obligation history records all of the obligations into which a dwelling has entered;
 * this includes dead obligations, which will not produce any future transactions
 * 
 * @author hinton
 * @since 3.7.0
 *
