...
/**
 * Represents a kind of energy used in a heating system; this would be an enum, were it not for the fact
 * that some heating systems (for example boilers) require an intermediate internal form of energy to
 * work out their efficiencies correctly.
 * 
 * @since 1.0.0
 * @author hinton
 *
