...
/**
 * Wraps a map from key type K to arrays of doubles of a certain dimension (dimension set by constructor {@link #DoubleMap(int)})
 * @author hinton
 *
 * @param <K>
 */
class DoubleMap<E extends Enum<E>> {
	...
	public String toString() {
		...
		for (final E e : ec.getEnumConstants()) {
			if (indices[e.ordinal()] == null) continue;
			sb.append(e);
			sb.append(": ");
