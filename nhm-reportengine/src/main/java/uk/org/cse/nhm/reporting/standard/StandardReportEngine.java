...
/**
 * This reporting service is an entry point for things that want to create reporting sessions.
 * 
 * A reporting session can be connected to an event queue or directly to a simulator, to create some reports.
 * 
 * @author hinton
 *
 */
