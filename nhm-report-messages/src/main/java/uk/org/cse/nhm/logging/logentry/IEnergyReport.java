...
public interface IEnergyReport {
	/**
	 * @param service
	 * @return the energy used by service between {@link #getDate()} and {@link #getUntil()}, in kWh
	 */
    double getEnergyUsedByService(final ServiceType service);
    
    /**
     * @param fuel
     * @return the amount of energy used as fuel, between {@link #getDate()} and {@link #getUntil()}, in kWh
     */
