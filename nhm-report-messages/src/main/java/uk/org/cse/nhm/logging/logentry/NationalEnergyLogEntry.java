...
/**
 * Stores national energy consumption by fuel type and by service type, for an interval of time.
 * 
 * Use {@link #getDate()} to get the start of the interval, and {@link #getUntil()} to get the end,
 * 
 * and {@link #getEnergyUsedByFuel(FuelType)} to get the total amount of the given fuel used (kWh), and
 * {@link #getEnergyUsedByService(ServiceType)} for the same by service
 * 
 * @author hinton
 *
 */
